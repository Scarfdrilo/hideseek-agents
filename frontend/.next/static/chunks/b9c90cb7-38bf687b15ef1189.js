...
`,ez=(0,R.iv)`
  ...
  ${eW.ensDark}
  ${eW.graphicsDark}
`,eB="auto",eD=eM(z.E.div)`
  ${eO.default}

  ${e=>{switch(e.$useTheme){case"web95":return eB="light",eO.web95;case"retro":return eB="light",eO.retro;case"soft":return eB="light",eO.soft;case"midnight":return eB="dark",eO.midnight;case"minimal":return eB="light",eO.minimal;case"rounded":return eB="light",eO.rounded;case"nouns":return eB="light",eO.nouns;default:if("light"===e.$useMode)return eB="light",eO.light;if("dark"===e.$useMode)return eB="dark",eO.dark;return(0,R.iv)`
  ...
  ${e=>{switch(eB){case"light":return eT;case"dark":return ez;default:return(0,R.iv)`
          ${eT}
          @media (prefers-color-scheme: dark) {
            ${ez}
          }
...
`,eR=e=>{let{selector:n,children:t}=e={selector:"__CONNECTKIT__",...e},o=(0,O.useRef)(null),[i,r]=(0,O.useState)(!1);return((0,O.useEffect)(()=>{let e="#"+n.replace(/^#/,"");if(o.current=document.querySelector(e),!o.current){let e=document.createElement("div");e.setAttribute("id",n),e.setAttribute("data-connectkit",`${rK}`),document.body.appendChild(e),o.current=e}r(!0)},[n]),o.current&&i)?(0,H.createPortal)(t,o.current):null};var eH={mobileWidth:560};let eZ=eM(z.E.div)`
  z-index: -1;
  pointer-events: auto;
  position: absolute;
  left: 50%;
...
`,e$=eM(z.E.div)`
  ...
  @media only screen and (max-width: ${eH.mobileWidth}px) {
    display: block;
  }
`,e1=eM(z.E.h1)`
  margin: 0;
...
`;let e2=eM(z.E.div)`
  ...
  opacity: 0;
  animation: ${e=>e.$active?eU:eY} 150ms ease-out
    both;
`,e3=(0,R.F4)`
...
Vui l\xf2ng thử lại.`,injectionScreen_notconnected_h1:`Đăng nhập v\xe0o {{ CONNECTORNAME }}`,injectionScreen_notconnected_p:`Để tiếp tục, vui l\xf2ng đăng nhập bằng tiện \xedch {{ CONNECTORNAME }}.`,profileScreen_heading:"Đ\xe3 kết nối",switchNetworkScreen_heading:"Đổi mạng",signInWithEthereumScreen_tooltip:"Bạn chưa đăng nhập v\xe0o ứng dụng.\n**Đăng nhập qua Ethereum** để tiếp tục.",signInWithEthereumScreen_signedOut_heading:"Đăng nhập qua Ethereum",signInWithEthereumScreen_signedOut_h1:"Ứng dụng n\xe0y muốn x\xe1c nhận bạn \n l\xe0 chủ sở hữu của v\xed.",signInWithEthereumScreen_signedOut_p:`Vui l\xf2ng k\xfd tin nhắn y\xeau cầu 
 ...
 x\xe1c nhận lại trong l\xe0n tiếp theo.`,signInWithEthereumScreen_signedIn_button:"Đăng xuất"},nH=e=>{switch(e){case"ee-EE":return n_;case"ar-AE":return nM;case"es-ES":return nI;case"fa-IR":return nA;case"fr-FR":return nF;case"ja-JP":return nO;case"pt-BR":return nW;case"ru-RU":return nT;case"zh-CN":return nz;case"ca-AD":return nB;case"tr-TR":return nD;case"vi-VN":return nR;default:return nL}};function nZ(e){var n,t;let o=null!==(t=null===(n=r_().options)||void 0===n?void 0:n.language)&&void 0!==t?t:"en-US",i=(0,O.useMemo)(()=>nH(o),[o]);if(!i)throw console.error(`Missing translations for: ${o}`),Error(`Missing translations for: ${o}`);let r={};return Object.keys(i).map(n=>{let t=i[n];return r[n]=nU(t,e)}),r}let nU=(e,n)=>{let t=e;return n&&Object.keys(n).forEach(e=>{t=t.replace(RegExp(`({{ ${e} }})`,"g"),n[e])}),nG(t)},nG=e=>{let n=e;return n=(n=n.split("\n")).map((e,t)=>(0,F.jsxs)(O.Fragment,{children:[nV(e),t<n.length-1&&(0,F.jsx)("br",{})]},t))},nV=e=>e.split(/(\*\*[^\*]*\*\*)/g).map((e,n)=>/(\*\*.*\*\*)/g.test(e)?(0,F.jsx)("strong",{children:e.replace(/\*\*/g,"")},n):`${e}`).map(e=>"string"==typeof e?e.split(/(\[WALLETCONNECTLOGO\])/g).map(e=>"[WALLETCONNECTLOGO]"===e?(0,F.jsx)("span",{className:"ck-tt-logo",children:(0,F.jsx)(ed.WalletConnect,{})},e):e):e),nY={debug:10,info:20,warn:30,error:40,none:100},nP="undefined"!=typeof window&&window.document&&void 0!==window.document.createElement?O.useLayoutEffect:O.useEffect,nQ=({logLevel:e="info",maxFontSize:n=100,minFontSize:t=20,onFinish:o,onStart:i,resolution:r=5}={})=>{let a=nY[e],s=(0,O.useCallback)(()=>({calcKey:0,fontSize:n,fontSizePrev:t,fontSizeMax:n,fontSizeMin:t}),[n,t]),c=(0,O.useRef)(null),l=(0,O.useRef)(),d=(0,O.useRef)(!1),[p,h]=(0,O.useState)(s),{calcKey:u,fontSize:g,fontSizeMax:x,fontSizeMin:b,fontSizePrev:C}=p,m=null,[f]=(0,O.useState)(()=>new V.Z(()=>{m=window.requestAnimationFrame(()=>{d.current||(i&&i(),d.current=!0,h({...s(),calcKey:u+1}))})}));(0,O.useEffect)(()=>(c.current&&f.observe(c.current),()=>{m&&window.cancelAnimationFrame(m),f.disconnect()}),[m,f]);let v=c.current&&c.current.innerHTML;return(0,O.useEffect)(()=>{0===u||d.current||(v!==l.current&&(i&&i(),h({...s(),calcKey:u+1})),l.current=v)},[u,s,v,i]),nP(()=>{let e;if(0===u)return;let n=Math.abs(g-C)<=r,i=!!c.current&&(c.current.scrollHeight>c.current.offsetHeight||c.current.scrollWidth>c.current.offsetWidth),s=i&&g===C,l=g>C;if(n){s?(d.current=!1,a<=nY.info&&console.info(`[use-fit-text] reached \`minFontSize = ${t}\` without fitting text`)):i?h({fontSize:l?C:b,fontSizeMax:x,fontSizeMin:b,fontSizePrev:C,calcKey:u}):(d.current=!1,o&&o(g));return}let p=x,m=b;i?(e=l?C-g:b-g,p=Math.min(x,g)):(e=l?x-g:C-g,m=Math.max(b,g)),h({calcKey:u,fontSize:g+e/2,fontSizeMax:p,fontSizeMin:m,fontSizePrev:g})},[u,g,x,b,C,o,c,r]),{fontSize:g,ref:c}},nX=({children:e})=>{let[n,t]=O.useState(!1),{fontSize:o,ref:i}=nQ({logLevel:"none",maxFontSize:100,minFontSize:70,onStart:()=>t(!0),onFinish:()=>t(!0)});return(0,F.jsx)("div",{ref:i,style:{visibility:n?"visible":"hidden",fontSize:`${o}%`,maxHeight:"100%",maxWidth:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:e})};function nJ(){let e=(0,l.Y)();return null!=e?e:[]}function nq(e,n){let t=nJ();return"injected"===e&&n?t.find(t=>t.id===e&&t.name===n):"injected"===e?t.find(n=>n.id===e&&n.name.includes("Injected")):t.find(n=>n.id===e)}function nK(){return nq("familyAccountsProvider")}function n$(){return nq("co.family.wallet")}nX.displayName="FitText";let n1=e=>n0().find(n=>n.id===e)||null,n0=()=>{let e=nJ(),n=r_();return e.map(e=>{var n,t;let o=Object.keys(eE).find(n=>-1!==n.split(",").map(e=>e.trim()).indexOf(e.id)),i={id:e.id,name:null!==(t=null!==(n=e.name)&&void 0!==n?n:e.id)&&void 0!==t?t:e.type,icon:(0,F.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}),connector:e,iconShape:"squircle",isInstalled:"mock"===e.type||"injected"===e.type&&"metaMask"!==e.id||ey(e.id)};if(o){let n=eE[o];return{...i,iconConnector:e.icon?(0,F.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}):void 0,...n}}return i}).filter((e,n,t)=>t.findIndex(n=>n.id===e.id)===n).map(e=>{var t,o;return"walletConnect"===e.id?{...e,name:(null===(t=n.options)||void 0===t?void 0:t.walletConnectName)||e.name,shortName:(null===(o=n.options)||void 0===o?void 0:o.walletConnectName)||e.shortName}:e}).filter((e,n,t)=>!("coinbaseWalletSDK"===e.id&&t.find(e=>"com.coinbase.wallet"===e.id))).filter((e,n,t)=>!(("metaMaskSDK"===e.id||"metaMask"===e.id)&&t.find(e=>"io.metamask"===e.id||"io.metamask.mobile"===e.id))).sort((e,n)=>{let t=e.isInstalled&&eS(e.connector.type),o=n.isInstalled&&eS(n.connector.type);return t&&!o?-1:!t&&o?1:0}).sort((e,n)=>"walletConnect"===e.id?1:"walletConnect"===n.id?-1:0)},n2=({isSignedIn:e})=>(0,F.jsxs)("div",{style:{position:"relative"},children:[e?(0,F.jsx)(nS,{style:{bottom:-1,right:-1}}):(0,F.jsx)("div",{style:{zIndex:2,position:"absolute",top:-2,right:-2,background:"#1A88F8",borderRadius:8,boxShadow:"0 0 0 2px var(--ck-body-background)",width:8,height:8}}),(0,F.jsxs)("svg",{"aria-hidden":"true",width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{overflow:"visible"},children:[(0,F.jsx)("circle",{cx:"10",cy:"10",r:"9",stroke:"currentColor",strokeWidth:"2"}),(0,F.jsx)("path",{d:"M16.5 16.775C14.8618 15.0649 12.5552 14 10 14C7.44477 14 5.13825 15.0649 3.5 16.775",stroke:"currentColor",strokeWidth:"2"}),(0,F.jsx)("circle",{cx:"10",cy:"8",r:"3",stroke:"currentColor",strokeWidth:"2"})]})]}),n3=({...e})=>(0,F.jsx)("svg",{"aria-hidden":"true",width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M20 11C20 15.9706 15.9706 20 11 20C6.02944 20 2 15.9706 2 11C2 6.02944 6.02944 2 11 2C15.9706 2 20 6.02944 20 11ZM22 11C22 17.0751 17.0751 22 11 22C4.92487 22 0 17.0751 0 11C0 4.92487 4.92487 0 11 0C17.0751 0 22 4.92487 22 11ZM11.6445 12.7051C11.6445 13.1348 11.3223 13.4678 10.7744 13.4678C10.2266 13.4678 9.92578 13.1885 9.92578 12.6191V12.4795C9.92578 11.4268 10.4951 10.8574 11.2686 10.3203C12.2031 9.67578 12.665 9.32129 12.665 8.59082C12.665 7.76367 12.0205 7.21582 11.043 7.21582C10.3232 7.21582 9.80762 7.57031 9.45312 8.16113C9.38282 8.24242 9.32286 8.32101 9.2667 8.39461C9.04826 8.68087 8.88747 8.8916 8.40039 8.8916C8.0459 8.8916 7.66992 8.62305 7.66992 8.15039C7.66992 7.96777 7.70215 7.7959 7.75586 7.61328C8.05664 6.625 9.27051 5.75488 11.1182 5.75488C12.9336 5.75488 14.5234 6.71094 14.5234 8.50488C14.5234 9.7832 13.7822 10.417 12.7402 11.1045C11.999 11.5986 11.6445 11.9746 11.6445 12.5762V12.7051ZM11.9131 15.5625C11.9131 16.1855 11.376 16.6797 10.7529 16.6797C10.1299 16.6797 9.59277 16.1748 9.59277 15.5625C9.59277 14.9395 10.1191 14.4453 10.7529 14.4453C11.3867 14.4453 11.9131 14.9287 11.9131 15.5625Z",fill:"currentColor"})}),n5=({...e})=>(0,F.jsx)(z.E.svg,{width:14,height:14,viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,F.jsx)("path",{d:"M1 13L13 1M1 1L13 13",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})}),n4=({...e})=>(0,F.jsx)(z.E.svg,{width:9,height:16,viewBox:"0 0 9 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,F.jsx)("path",{d:"M8 1L1 8L8 15",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),n9={initial:{zIndex:2,opacity:0},animate:{opacity:1,scale:1,transition:{duration:.165,delay:.055,ease:[.26,.08,.25,1]}},exit:{zIndex:1,opacity:0,pointerEvents:"none",position:"absolute",left:["50%","50%"],x:["-50%","-50%"],transition:{duration:.22,ease:[.26,.08,.25,1]}}},n8=({open:e,pages:n,pageId:t,positionInside:o,inline:i,demo:r,onClose:a,onBack:s,onInfo:c})=>{var l,h,u,g,x,b,C,m,f,v,k,w;let y;let j=r_(),S=nC(),E=ef(),{isSignedIn:N,reset:L}=nN(),M=n1(null===(l=j.connector)||void 0===l?void 0:l.id),_={name:null==M?void 0:M.name,shortName:null!==(h=null==M?void 0:M.shortName)&&void 0!==h?h:null==M?void 0:M.name,icon:null!==(u=null==M?void 0:M.iconConnector)&&void 0!==u?u:null==M?void 0:M.icon,iconShape:null!==(g=null==M?void 0:M.iconShape)&&void 0!==g?g:"circle",iconShouldShrink:null==M?void 0:M.iconShouldShrink},I=nZ({CONNECTORNAME:null==_?void 0:_.name}),[A,W]=(0,P.Y)({timeout:160,preEnter:!0,mountOnEnter:!0,unmountOnExit:!0}),T=!("exited"===A||"unmounted"===A),D="preEnter"===A||"exiting"!==A,R=j.route===rN.CONNECTORS?0:j.route===rN.DOWNLOAD?2:1,H=ng(R,R);o||nh(T),ng(t,t),(0,O.useEffect)(()=>{W(e),e&&V(void 0)},[e]);let[Z,U]=(0,O.useState)({width:void 0,height:void 0}),[G,V]=(0,O.useState)(void 0),Y=e=>{let n={width:null==e?void 0:e.offsetWidth,height:null==e?void 0:e.offsetHeight};U({width:`${null==n?void 0:n.width}px`,height:`${null==n?void 0:n.height}px`})},Q=(0,O.useCallback)(e=>{e&&(q.current=e,V(void 0!==G),clearTimeout(y),y=setTimeout(()=>V(!1),360),Y(e))},[e,G]),{chain:X}=(0,d.R)(),{switchChain:J}=(0,p.o)(),q=(0,O.useRef)(null);(0,O.useEffect)(()=>{q.current&&Y(q.current)},[X,J,E,N,j.options,j.resize]),(0,O.useEffect)(()=>{if(!T){U({width:void 0,height:void 0});return}let e=e=>{"Escape"===e.key&&a&&a()};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}},[T,a]);let K={"--height":Z.height,"--width":Z.width},$=(0,F.jsx)(eD,{$useTheme:null!==(x=null==r?void 0:r.theme)&&void 0!==x?x:S.theme,$useMode:null!==(b=null==r?void 0:r.mode)&&void 0!==b?b:S.mode,$customTheme:null!==(C=null==r?void 0:r.customTheme)&&void 0!==C?C:S.customTheme,children:(0,F.jsxs)(nt,{role:"dialog",style:{pointerEvents:D?"auto":"none",position:o?"absolute":void 0},children:[!i&&(0,F.jsx)(e2,{$active:D,onClick:a,$blur:null===(m=j.options)||void 0===m?void 0:m.overlayBlur}),(0,F.jsxs)(ns,{style:K,initial:!1,children:[(0,F.jsx)("div",{style:{pointerEvents:G?"all":"none",position:"absolute",top:0,bottom:0,left:"50%",transform:"translateX(-50%)",width:"var(--width)",zIndex:9,transition:"width 200ms ease"}}),(0,F.jsxs)(e8,{className:`${D&&"active"}`,children:[(0,F.jsx)(B.M,{initial:!1,children:(null===(f=j.options)||void 0===f?void 0:f.disclaimer)&&j.route===rN.CONNECTORS&&(0,F.jsx)(nl,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{delay:0,duration:.2,ease:[.25,.1,.25,1]},children:(0,F.jsx)(nc,{children:(0,F.jsx)("div",{children:null===(v=j.options)||void 0===v?void 0:v.disclaimer})})})}),(0,F.jsx)(B.M,{initial:!1,children:j.errorMessage&&(0,F.jsxs)(eZ,{initial:{y:"10%",x:"-50%"},animate:{y:"-100%"},exit:{y:"100%"},transition:{duration:.2,ease:"easeInOut"},children:[(0,F.jsx)("span",{children:j.errorMessage}),(0,F.jsx)("div",{onClick:()=>j.displayError(null),style:{position:"absolute",right:24,top:24,cursor:"pointer"},children:(0,F.jsx)(n5,{})})]})}),(0,F.jsxs)(e6,{children:[a&&(0,F.jsx)(no,{"aria-label":ev(I.close).toString(),onClick:a,children:(0,F.jsx)(n5,{})}),(0,F.jsx)("div",{style:{position:"absolute",top:23,left:20,width:32,height:32},children:(0,F.jsx)(B.M,{children:s?(0,F.jsx)(nr,{disabled:G,"aria-label":ev(I.back).toString(),onClick:s,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:E?0:.1,delay:E?.01:0},children:(0,F.jsx)(n4,{})},"backButton"):j.route===rN.PROFILE&&j.signInWithEthereum?(0,F.jsxs)(F.Fragment,{children:[!N&&!(null===(k=j.options)||void 0===k?void 0:k.hideTooltips)&&(0,F.jsx)(z.E.div,{style:{position:"absolute",inset:0,pointerEvents:"none"},initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1,transition:{delay:.5,duration:.2}},exit:{opacity:0,scale:.6,transition:{delay:0,duration:E?0:.1}},children:(0,F.jsx)(nd,{children:I.signInWithEthereumScreen_tooltip})}),(0,F.jsx)(ni,{disabled:G,"aria-label":I.signInWithEthereumScreen_signedOut_heading,onClick:()=>{L(),j.setRoute(rN.SIGNINWITHETHEREUM)},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:E?0:.1,delay:E?.01:0},children:(0,F.jsx)(n2,{isSignedIn:N})},"siweButton")]}):c&&!(null===(w=j.options)||void 0===w?void 0:w.hideQuestionMarkCTA)&&(0,F.jsx)(na,{disabled:G,"aria-label":ev(I.moreInformation).toString(),onClick:c,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:E?0:.1,delay:E?.01:0},children:(0,F.jsx)(n3,{})},"infoButton")})})]}),(0,F.jsx)(eq,{children:(0,F.jsx)(B.M,{children:(0,F.jsx)(z.E.div,{style:{position:"absolute",top:0,bottom:0,left:52,right:52,display:"flex",justifyContent:"center"},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:E?0:.17,delay:E?.01:0},children:(0,F.jsx)(nX,{children:function(){var e;switch(j.route){case rN.ABOUT:return I.aboutScreen_heading;case rN.CONNECT:if(M&&!(!M.getWalletConnectDeeplink||M.isInstalled))return ek(null===(e=null==M?void 0:M.connector)||void 0===e?void 0:e.id)?I.scanScreen_heading:I.scanScreen_heading_withConnector;return null==_?void 0:_.name;case rN.CONNECTORS:return I.connectorsScreen_heading;case rN.MOBILECONNECTORS:return I.mobileConnectorsScreen_heading;case rN.DOWNLOAD:return I.downloadAppScreen_heading;case rN.ONBOARDING:return I.onboardingScreen_heading;case rN.PROFILE:return I.profileScreen_heading;case rN.SWITCHNETWORKS:return I.switchNetworkScreen_heading;case rN.SIGNINWITHETHEREUM:return N?I.signInWithEthereumScreen_signedIn_heading:I.signInWithEthereumScreen_signedOut_heading;default:return""}}()})},`${j.route}-${N?"signedIn":""}`)})}),(0,F.jsx)(e7,{children:Object.keys(n).map(e=>{let i=n[e];return(0,F.jsx)(n6,{open:e===t,initial:!o&&"entered"!==A,enterAnim:e===t?R>H?"active-scale-up":"active":"",exitAnim:e!==t?R<H?"exit-scale-down":"exit":"",children:(0,F.jsx)(nn,{ref:Q,style:{pointerEvents:e===t&&D?"auto":"none"},children:i},`inner-${e}`)},e)})})]})]})]})});return(0,F.jsx)(F.Fragment,{children:T&&(0,F.jsx)(F.Fragment,{children:o?$:(0,F.jsx)(F.Fragment,{children:(0,F.jsx)(eR,{children:(0,F.jsx)(nu,{children:$})})})})})},n6=({children:e,open:n,initial:t,prevDepth:o,currentDepth:i,enterAnim:r,exitAnim:a})=>{let[s,c]=(0,P.Y)({timeout:400,preEnter:!0,initialEntered:n,mountOnEnter:!0,unmountOnExit:!0});return((0,O.useEffect)(()=>{c(n)},[n]),"exited"===s||"unmounted"===s)?null:(0,F.jsx)(ne,{className:`${"preEnter"===s||"exiting"!==s?r:a}`,style:{animationDuration:t?"0ms":void 0,animationDelay:t?"0ms":void 0},children:e})},n7=({children:e,hideHr:n})=>{let t=nZ();return(0,F.jsx)(eJ,{$disableHr:n,children:(0,F.jsx)("span",{children:null!=e?e:t.or})})},te=eM(z.E.div)`
  position: relative;
...
`,to=eM(z.E.div)`
  ...
  animation: ${tt} 1000ms 100ms ease both;
  @media only screen and (max-width: ${eH.mobileWidth}px) {
    animation: none;
  }
`,ti=(0,R.F4)`
...
`,th=eM(z.E.div)`
  ...
  animation: ${ti} 750ms cubic-bezier(0.19, 1, 0.22, 1) both;
  ...
  &:nth-child(1){ ${tp}{ animation-delay:0ms; } }
  &:nth-child(2){ ${tp}{ animation-delay:-600ms; } }
  &:nth-child(3){ ${tp}{ animation-delay:-1200ms; } }
  &:nth-child(4){ ${tp}{ animation-delay:-1800ms; } }
  &:nth-child(5){ ${tp}{ animation-delay:-2400ms; } }
...
`,tk=eM.button`
  ...
  @media only screen and (min-width: ${eH.mobileWidth+1}px) {
    &:hover,
    &:focus-visible {
...
`,tS=eM(z.E.div)`
  ...
  svg {
    display: block;
    position: relative;
    animation: ${tj} 1s ease-in-out infinite;
  }
`,tE={duration:.4,ease:[.175,.885,.32,.98]},tN=()=>(0,F.jsx)(tS,{initial:{opacity:0,rotate:180},animate:{opacity:1,rotate:0},exit:{position:"absolute",opacity:0,rotate:-180,transition:{...tE}},transition:{...tE,delay:.2},children:(0,F.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("circle",{cx:"9",cy:"9",r:"7",stroke:"currentColor",strokeOpacity:"0.1",strokeWidth:"2.5"}),(0,F.jsx)("path",{d:"M16 9C16 5.13401 12.866 2 9 2",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round"})]})}),tL={duration:.4,ease:[.175,.885,.32,.98]},tM=({children:e,variant:n="secondary",disabled:t,icon:o,iconPosition:i="left",roundedIcon:r,waiting:a,arrow:s,download:c,href:l,style:d,onClick:p})=>{let h="string"==typeof e?e:ev(e).join(""),u=l&&("string"==typeof l?l:ev(l).join(""));return(0,F.jsx)(tk,{as:l?"a":void 0,onClick:e=>{!t&&p&&p(e)},href:u,target:l&&"_blank",rel:l&&"noopener noreferrer",disabled:t,$variant:n,style:d,children:(0,F.jsxs)(B.M,{initial:!1,children:[(0,F.jsxs)(tv,{initial:{opacity:0,y:-10},animate:{opacity:1,y:-1},exit:{position:"absolute",opacity:0,y:10,transition:{...tL}},transition:{...tL,delay:.2},children:[o&&"left"===i&&(0,F.jsx)(ty,{$rounded:r,children:o}),c&&(0,F.jsx)(tm,{children:(0,F.jsx)(tf,{children:(0,F.jsxs)(tx,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)(tC,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"}),(0,F.jsx)(tb,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"})]})})}),(0,F.jsx)(tw,{style:{paddingLeft:s?6:0},children:(0,F.jsx)(nX,{children:e})}),o&&"right"===i&&(0,F.jsx)(ty,{$rounded:r,children:o}),s&&(0,F.jsxs)(tx,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)(tC,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"2",strokeLinecap:"round"}),(0,F.jsx)(tb,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"2",strokeLinecap:"round"})]})]},h),a&&(0,F.jsx)(tg,{children:(0,F.jsx)(tN,{})})]})})},t_=()=>{var e,n;let t=r_(),o=nZ({}),i=null!==(n=null===(e=t.options)||void 0===e?void 0:e.walletOnboardingUrl)&&void 0!==n?n:o.onboardingScreen_ctaUrl;return(0,F.jsxs)(eX,{children:[(0,F.jsxs)(te,{children:[(0,F.jsxs)(tn,{children:[(0,F.jsx)(th,{children:(0,F.jsx)(tr,{children:(0,F.jsx)(ta,{children:(0,F.jsx)(tl,{children:(0,F.jsx)(tp,{children:(0,F.jsx)(ts,{children:(0,F.jsx)(ed.Coinbase,{background:!0})})})})})})}),(0,F.jsx)(th,{children:(0,F.jsx)(tr,{children:(0,F.jsx)(ta,{children:(0,F.jsx)(tl,{children:(0,F.jsx)(tp,{children:(0,F.jsx)(ts,{children:(0,F.jsx)(ed.MetaMask,{background:!0})})})})})})}),(0,F.jsx)(th,{children:(0,F.jsx)(tr,{children:(0,F.jsx)(ta,{children:(0,F.jsx)(tl,{children:(0,F.jsx)(tp,{children:(0,F.jsx)(ts,{children:(0,F.jsx)(ed.Trust,{})})})})})})}),(0,F.jsx)(th,{children:(0,F.jsx)(tr,{children:(0,F.jsx)(ta,{children:(0,F.jsx)(tl,{children:(0,F.jsx)(tp,{children:(0,F.jsx)(ts,{children:(0,F.jsx)(ed.Argent,{})})})})})})}),(0,F.jsx)(th,{children:(0,F.jsx)(tr,{children:(0,F.jsx)(ta,{children:(0,F.jsx)(tl,{children:(0,F.jsx)(tp,{children:(0,F.jsx)(ts,{children:(0,F.jsx)(ed.ImToken,{})})})})})})})]}),(0,F.jsx)(to,{children:tu})]}),(0,F.jsxs)(e$,{style:{paddingBottom:18},children:[(0,F.jsx)(e1,{$small:!0,children:o.onboardingScreen_h1}),(0,F.jsx)(e0,{children:o.onboardingScreen_p})]}),(0,F.jsx)(tM,{href:i,arrow:!0,children:o.onboardingScreen_ctaText})]})},tI=eM.div`
  pointer-events: none;
  user-select: none;
  height: ${208}px;
  padding: 0 0 12px;
...
`,tB=eM.button`
  ...
  ${e=>e.$active?(0,R.iv)`
        ...
        `}
`,tD={scale:[.9,1.25,1.6],opacity:[0,.11,0]},tR={ease:"linear",duration:2,repeat:1/0},tH=eM.div`
  position: absolute;
  left: 50%;
  top: 50%;
...
`,tU=eM(z.E.div)`
  ...
  overflow: hidden;
  border-radius: 100%;
  animation: ${tZ} 16s linear infinite;
`,tG=eM(z.E.div)`
  overflow: hidden;
...
`,tY=eM(z.E.div)`
  ...
  justify-content: center;
  border-radius: 50%;
`,tP=(0,F.jsxs)("svg",{width:"34",height:"34",viewBox:"0 0 34 34",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("path",{d:"M17 34C26.3 34 34 26.2833 34 17C34 7.7 26.2833 0 16.9833 0C7.7 0 0 7.7 0 17C0 26.2833 7.71667 34 17 34ZM9.83333 25.6833C8.68333 26.2333 7.8 25.3333 8.33333 24.2L13.1667 14.3333C13.45 13.75 13.8167 13.3833 14.35 13.1333L24.1833 8.33333C25.4 7.75 26.25 8.65 25.6833 9.81667L20.8833 19.6667C20.6167 20.2 20.2333 20.6 19.6833 20.85L9.83333 25.6833ZM17.0167 19.1333C18.1833 19.1333 19.1333 18.1833 19.1333 17.0167C19.1333 15.85 18.1833 14.9167 17.0167 14.9167C15.8667 14.9167 14.9167 15.85 14.9167 17.0167C14.9167 18.1833 15.8667 19.1333 17.0167 19.1333Z",fill:"var(--ck-graphic-compass-color, var(--ck-body-color))"}),(0,F.jsx)("path",{d:"M17 34C26.3 34 34 26.2833 34 17C34 7.7 26.2833 0 16.9833 0C7.7 0 0 7.7 0 17C0 26.2833 7.71667 34 17 34ZM9.83333 25.6833C8.68333 26.2333 7.8 25.3333 8.33333 24.2L13.1667 14.3333C13.45 13.75 13.8167 13.3833 14.35 13.1333L24.1833 8.33333C25.4 7.75 26.25 8.65 25.6833 9.81667L20.8833 19.6667C20.6167 20.2 20.2333 20.6 19.6833 20.85L9.83333 25.6833ZM17.0167 19.1333C18.1833 19.1333 19.1333 18.1833 19.1333 17.0167C19.1333 15.85 18.1833 14.9167 17.0167 14.9167C15.8667 14.9167 14.9167 15.85 14.9167 17.0167C14.9167 18.1833 15.8667 19.1333 17.0167 19.1333Z",fill:"url(#ck-compass-gradient)"}),(0,F.jsx)("defs",{children:(0,F.jsxs)("linearGradient",{id:"ck-compass-gradient",x1:"17",y1:"0",x2:"17",y2:"34",gradientUnits:"userSpaceOnUse",children:[(0,F.jsx)("stop",{stopColor:"rgba(0,0,0,0)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"rgba(0,0,0,0.05)"})]})})]}),tQ=({inverted:e=!1})=>(0,F.jsxs)("svg",{width:"58",height:"50",viewBox:"0 0 58 50",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M57.9332 20.3335V42.1113C57.9332 46.4069 54.451 49.8891 50.1555 49.8891H8.15546C3.85991 49.8891 0.377686 46.4069 0.377686 42.1113V25.0002V7.8891C0.377686 3.59355 3.85991 0.111328 8.15546 0.111328H47.0444C48.7626 0.111328 50.1555 1.50422 50.1555 3.22244C50.1555 4.94066 48.7626 6.33355 47.0443 6.33355H9.71102C7.9928 6.33355 6.59991 7.72644 6.59991 9.44466C6.59991 11.1629 7.9928 12.5558 9.71102 12.5558H50.1555C54.451 12.5558 57.9332 16.038 57.9332 20.3335ZM46.2667 34.3337C48.4145 34.3337 50.1556 32.5926 50.1556 30.4448C50.1556 28.297 48.4145 26.5559 46.2667 26.5559C44.1189 26.5559 42.3778 28.297 42.3778 30.4448C42.3778 32.5926 44.1189 34.3337 46.2667 34.3337Z",fill:e?"var(--ck-graphic-primary-color, var(--ck-body-background))":"var(--ck-graphic-primary-color, var(--ck-body-color))"}),(0,F.jsx)("defs",{children:(0,F.jsxs)("linearGradient",{id:"paint0_linear_2501_7732",x1:"29.1555",y1:"0.111328",x2:"29.1555",y2:"49.8891",gradientUnits:"userSpaceOnUse",children:[(0,F.jsx)("stop",{stopColor:e?"var(--ck-body-color-muted)":"var(--ck-body-background-transparent, transparent)"}),(0,F.jsx)("stop",{offset:"1",stopColor:e?"var(--ck-body-color)":"var(--ck-body-background)"})]})})]}),tX=(0,F.jsx)("svg",{width:"41",height:"41",viewBox:"0 0 41 41",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,F.jsx)("path",{d:"M35.4446 0.839914L2.14484 10.7065C0.0395033 11.3303 -0.632966 13.9786 0.919705 15.5313L7.9624 22.574C9.47585 24.0874 11.8661 24.273 13.5951 23.0114L25.2866 14.4797C25.5558 14.2832 25.9281 14.3121 26.1638 14.5478C26.3998 14.7838 26.4285 15.1567 26.2313 15.426L17.6874 27.0937C16.4213 28.8228 16.6052 31.2168 18.1206 32.7322L25.1811 39.7926C26.7337 41.3453 29.382 40.6728 30.0058 38.5675L39.8724 5.2677C40.6753 2.55794 38.1544 0.037024 35.4446 0.839914Z",fill:"var(--ck-graphic-secondary-color, white)"})}),tJ=(0,F.jsx)("svg",{width:"38",height:"44",viewBox:"0 0 38 44",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M19 0.875C21.4853 0.875 23.5 2.88972 23.5 5.375V27.761L30.068 21.193C31.8254 19.4357 34.6746 19.4357 36.432 21.193C38.1893 22.9504 38.1893 25.7996 36.432 27.557L22.182 41.807C20.4246 43.5643 17.5754 43.5643 15.818 41.807L1.56802 27.557C-0.18934 25.7996 -0.18934 22.9504 1.56802 21.193C3.32538 19.4357 6.17462 19.4357 7.93198 21.193L14.5 27.761V5.375C14.5 2.88972 16.5147 0.875 19 0.875Z",fill:"var(--ck-graphic-secondary-color, white)"})}),tq=({...e})=>{var n;let t=null!==(n=null==e?void 0:e.id)&&void 0!==n?n:"";return(0,F.jsxs)("svg",{...e,width:"81",height:"81",viewBox:"0 0 81 81",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M81 27C81 41.9117 68.9117 54 54 54C51.2722 54 48.6389 53.5955 46.1568 52.8432L36 63H27V72H18V81H4.5C2.01472 81 0 78.9853 0 76.5V64.864C0 63.6705 0.474103 62.5259 1.31802 61.682L28.1568 34.8432C27.4045 32.3611 27 29.7278 27 27C27 12.0883 39.0883 0 54 0C68.9117 0 81 12.0883 81 27ZM60.75 25.875C63.8566 25.875 66.375 23.3566 66.375 20.25C66.375 17.1434 63.8566 14.625 60.75 14.625C57.6434 14.625 55.125 17.1434 55.125 20.25C55.125 23.3566 57.6434 25.875 60.75 25.875Z",fill:`url(#${t}paint0_linear_2509_6177)`}),(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M81 27C81 41.9117 68.9117 54 54 54C51.2722 54 48.6389 53.5955 46.1568 52.8432L36 63H27V72H18V81H4.5C2.01472 81 0 78.9853 0 76.5V64.864C0 63.6705 0.474103 62.5259 1.31802 61.682L28.1568 34.8432C27.4045 32.3611 27 29.7278 27 27C27 12.0883 39.0883 0 54 0C68.9117 0 81 12.0883 81 27ZM60.75 25.875C63.8566 25.875 66.375 23.3566 66.375 20.25C66.375 17.1434 63.8566 14.625 60.75 14.625C57.6434 14.625 55.125 17.1434 55.125 20.25C55.125 23.3566 57.6434 25.875 60.75 25.875Z",fill:`url(#${t}paint1_radial_2509_6177)`,fillOpacity:"0.2"}),(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M44.5658 51.2522C45.1527 50.6653 46.0151 50.4492 46.8095 50.6899C49.0823 51.3788 51.4958 51.75 54 51.75C67.6691 51.75 78.75 40.669 78.75 27C78.75 13.331 67.6691 2.25 54 2.25C40.331 2.25 29.25 13.331 29.25 27C29.25 29.5042 29.6212 31.9177 30.3101 34.1905C30.5508 34.9849 30.3347 35.8473 29.7478 36.4342L2.90901 63.273C2.48705 63.6949 2.25 64.2672 2.25 64.864V76.5C2.25 77.7426 3.25736 78.75 4.5 78.75H15.75V72C15.75 70.7574 16.7574 69.75 18 69.75H24.75V63C24.75 61.7574 25.7574 60.75 27 60.75H35.068L44.5658 51.2522ZM36 63H27V72H18V81H4.5C2.01472 81 0 78.9853 0 76.5V64.864C0 63.6705 0.474103 62.5259 1.31802 61.682L28.1568 34.8432C27.4045 32.3611 27 29.7278 27 27C27 12.0883 39.0883 0 54 0C68.9117 0 81 12.0883 81 27C81 41.9117 68.9117 54 54 54C51.2722 54 48.6389 53.5955 46.1568 52.8432L36 63ZM68.625 20.25C68.625 24.5992 65.0992 28.125 60.75 28.125C56.4008 28.125 52.875 24.5992 52.875 20.25C52.875 15.9008 56.4008 12.375 60.75 12.375C65.0992 12.375 68.625 15.9008 68.625 20.25ZM66.375 20.25C66.375 23.3566 63.8566 25.875 60.75 25.875C57.6434 25.875 55.125 23.3566 55.125 20.25C55.125 17.1434 57.6434 14.625 60.75 14.625C63.8566 14.625 66.375 17.1434 66.375 20.25Z",fill:"black",fillOpacity:"0.1"}),(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M33.4205 47.5795C33.8598 48.0188 33.8598 48.7312 33.4205 49.1705L3.0455 79.5455C2.60616 79.9848 1.89384 79.9848 1.4545 79.5455C1.01517 79.1062 1.01517 78.3938 1.4545 77.9545L31.8295 47.5795C32.2688 47.1402 32.9812 47.1402 33.4205 47.5795Z",fill:"#A5A9AD"}),(0,F.jsxs)("defs",{children:[(0,F.jsxs)("linearGradient",{id:`${t}paint0_linear_2509_6177`,x1:"72",y1:"5.625",x2:"2.25",y2:"78.75",gradientUnits:"userSpaceOnUse",children:[(0,F.jsx)("stop",{stopColor:"#D4DFE6"}),(0,F.jsx)("stop",{offset:"0.0967282",stopColor:"#C6CACD"}),(0,F.jsx)("stop",{offset:"0.526645",stopColor:"#BDBAC4"}),(0,F.jsx)("stop",{offset:"1",stopColor:"#939CA1"})]}),(0,F.jsxs)("radialGradient",{id:`${t}paint1_radial_2509_6177`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(52.875 12.375) rotate(93.2705) scale(39.4392)",children:[(0,F.jsx)("stop",{stopColor:"white"}),(0,F.jsx)("stop",{offset:"1",stopColor:"white"})]})]})]})},tK=(0,F.jsxs)("svg",{width:"131",height:"14",viewBox:"0 0 131 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("path",{d:"M5.74805 13.2549C8.86816 13.2549 10.7227 10.6973 10.7227 6.63672C10.7227 2.57617 8.85059 0.0625 5.74805 0.0625C2.63672 0.0625 0.755859 2.59375 0.755859 6.64551C0.755859 10.7148 2.61914 13.2549 5.74805 13.2549ZM5.74805 11.4004C4.02539 11.4004 3.04102 9.64258 3.04102 6.63672C3.04102 3.68359 4.04297 1.91699 5.74805 1.91699C7.44434 1.91699 8.4375 3.6748 8.4375 6.64551C8.4375 9.65137 7.46191 11.4004 5.74805 11.4004Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M13.0869 13.1758C13.4561 13.1758 13.6934 13.0439 13.9658 12.6221L15.9697 9.66016H16.0137L18.0264 12.6572C18.2549 13.0088 18.4922 13.1758 18.8965 13.1758C19.4854 13.1758 19.9424 12.7891 19.9424 12.209C19.9424 11.9805 19.8633 11.7695 19.7051 11.541L17.376 8.28906L19.6963 5.16016C19.8896 4.90527 19.9688 4.68555 19.9688 4.43066C19.9688 3.88574 19.5381 3.49902 18.9229 3.49902C18.5361 3.49902 18.2988 3.6748 18.0176 4.10547L16.1191 6.95312H16.0752L14.1328 4.08789C13.8516 3.64844 13.6318 3.49902 13.2012 3.49902C12.6035 3.49902 12.1465 3.91211 12.1465 4.44824C12.1465 4.70312 12.2256 4.92285 12.3838 5.13379L14.7129 8.35059L12.3486 11.5498C12.1641 11.8135 12.0762 12.0156 12.0762 12.2705C12.0762 12.7979 12.498 13.1758 13.0869 13.1758Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M26.2441 13.2549C29.1445 13.2549 31.1924 11.7432 31.1924 9.57227C31.1924 7.9375 30.0146 6.68066 28.3184 6.3291V6.27637C29.7773 5.87207 30.7178 4.7998 30.7178 3.45508C30.7178 1.48633 28.8633 0.0625 26.2441 0.0625C23.625 0.0625 21.7617 1.49512 21.7617 3.44629C21.7617 4.80859 22.7109 5.88965 24.1699 6.27637V6.3291C22.4736 6.67188 21.3047 7.92871 21.3047 9.57227C21.3047 11.7344 23.335 13.2549 26.2441 13.2549ZM26.2441 5.55566C24.9258 5.55566 24.0029 4.78223 24.0029 3.6748C24.0029 2.55859 24.9258 1.77637 26.2441 1.77637C27.5537 1.77637 28.4854 2.5498 28.4854 3.6748C28.4854 4.78223 27.5537 5.55566 26.2441 5.55566ZM26.2441 11.5234C24.7236 11.5234 23.6514 10.6357 23.6514 9.40527C23.6514 8.1748 24.7236 7.28711 26.2441 7.28711C27.7646 7.28711 28.8369 8.16602 28.8369 9.40527C28.8369 10.6357 27.7646 11.5234 26.2441 11.5234Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M36.3164 13.1494C37.7578 13.1494 38.7598 12.4199 39.208 11.3477H39.252V12.0771C39.252 12.7891 39.7266 13.1758 40.3594 13.1758C40.9922 13.1758 41.4404 12.7803 41.4404 12.0771V1.29297C41.4404 0.554688 40.9834 0.141602 40.3418 0.141602C39.7002 0.141602 39.252 0.554688 39.252 1.29297V5.24805H39.1992C38.707 4.21973 37.6523 3.52539 36.3164 3.52539C33.9697 3.52539 32.4492 5.38867 32.4492 8.33301C32.4492 11.2949 33.9697 13.1494 36.3164 13.1494ZM36.9756 11.3564C35.5605 11.3564 34.6904 10.1963 34.6904 8.3418C34.6904 6.49609 35.5693 5.32715 36.9756 5.32715C38.3555 5.32715 39.2607 6.51367 39.2607 8.3418C39.2607 10.1875 38.3555 11.3564 36.9756 11.3564Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M44.0508 13.1494C44.6396 13.1494 44.9736 12.8594 45.1846 12.1738L46.0195 9.76562H50.7568L51.5918 12.1914C51.7939 12.8682 52.1367 13.1494 52.752 13.1494C53.4111 13.1494 53.8857 12.7188 53.8857 12.1035C53.8857 11.9014 53.8418 11.6992 53.7363 11.4092L50.0449 1.38965C49.7285 0.537109 49.2188 0.167969 48.3838 0.167969C47.5576 0.167969 47.0479 0.554688 46.7402 1.39844L43.0576 11.4092C42.9521 11.6816 42.9082 11.9277 42.9082 12.1035C42.9082 12.7451 43.3564 13.1494 44.0508 13.1494ZM46.5557 7.97266L48.3398 2.55859H48.4014L50.2031 7.97266H46.5557Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M60.1172 13.2549C62.8594 13.2549 64.8545 11.4004 64.8545 8.8252C64.8545 6.42578 63.1406 4.66797 60.6973 4.66797C58.9746 4.66797 57.709 5.54688 57.208 6.71582H57.1641V6.58398C57.208 3.66602 58.2275 1.89941 60.1436 1.89941C61.084 1.89941 61.7607 2.26855 62.3496 3.07715C62.7012 3.52539 62.9824 3.73633 63.4307 3.73633C64.0283 3.73633 64.3975 3.34082 64.3975 2.82227C64.3975 2.57617 64.3359 2.35645 64.1953 2.10156C63.5625 0.897461 62.0859 0.0537109 60.1523 0.0537109C56.9268 0.0537109 54.9932 2.57617 54.9932 6.80371C54.9932 8.24512 55.2305 9.45801 55.6963 10.4336C56.5752 12.2881 58.1396 13.2549 60.1172 13.2549ZM60.082 11.4092C58.667 11.4092 57.5508 10.293 57.5508 8.86914C57.5508 7.4541 58.6494 6.41699 60.1084 6.41699C61.5674 6.41699 62.6309 7.4541 62.6221 8.91309C62.6221 10.3018 61.4971 11.4092 60.082 11.4092Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M68.1328 8.83398C68.8447 8.83398 69.416 8.27148 69.416 7.55078C69.416 6.83008 68.8447 6.25879 68.1328 6.25879C67.4121 6.25879 66.8408 6.83008 66.8408 7.55078C66.8408 8.27148 67.4121 8.83398 68.1328 8.83398Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M73.3359 8.83398C74.0479 8.83398 74.6191 8.27148 74.6191 7.55078C74.6191 6.83008 74.0479 6.25879 73.3359 6.25879C72.6152 6.25879 72.0439 6.83008 72.0439 7.55078C72.0439 8.27148 72.6152 8.83398 73.3359 8.83398Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M78.5391 8.83398C79.251 8.83398 79.8223 8.27148 79.8223 7.55078C79.8223 6.83008 79.251 6.25879 78.5391 6.25879C77.8184 6.25879 77.2471 6.83008 77.2471 7.55078C77.2471 8.27148 77.8184 8.83398 78.5391 8.83398Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M83.7422 8.83398C84.4541 8.83398 85.0254 8.27148 85.0254 7.55078C85.0254 6.83008 84.4541 6.25879 83.7422 6.25879C83.0215 6.25879 82.4502 6.83008 82.4502 7.55078C82.4502 8.27148 83.0215 8.83398 83.7422 8.83398Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M92.2148 13.2549C94.957 13.2549 96.9521 11.4004 96.9521 8.8252C96.9521 6.42578 95.2383 4.66797 92.7949 4.66797C91.0723 4.66797 89.8066 5.54688 89.3057 6.71582H89.2617V6.58398C89.3057 3.66602 90.3252 1.89941 92.2412 1.89941C93.1816 1.89941 93.8584 2.26855 94.4473 3.07715C94.7988 3.52539 95.0801 3.73633 95.5283 3.73633C96.126 3.73633 96.4951 3.34082 96.4951 2.82227C96.4951 2.57617 96.4336 2.35645 96.293 2.10156C95.6602 0.897461 94.1836 0.0537109 92.25 0.0537109C89.0244 0.0537109 87.0908 2.57617 87.0908 6.80371C87.0908 8.24512 87.3281 9.45801 87.7939 10.4336C88.6729 12.2881 90.2373 13.2549 92.2148 13.2549ZM92.1797 11.4092C90.7646 11.4092 89.6484 10.293 89.6484 8.86914C89.6484 7.4541 90.7471 6.41699 92.2061 6.41699C93.665 6.41699 94.7285 7.4541 94.7197 8.91309C94.7197 10.3018 93.5947 11.4092 92.1797 11.4092Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M103.377 13.2549C106.497 13.2549 108.352 10.6973 108.352 6.63672C108.352 2.57617 106.479 0.0625 103.377 0.0625C100.266 0.0625 98.3848 2.59375 98.3848 6.64551C98.3848 10.7148 100.248 13.2549 103.377 13.2549ZM103.377 11.4004C101.654 11.4004 100.67 9.64258 100.67 6.63672C100.67 3.68359 101.672 1.91699 103.377 1.91699C105.073 1.91699 106.066 3.6748 106.066 6.64551C106.066 9.65137 105.091 11.4004 103.377 11.4004Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M117.167 13.1758C117.8 13.1758 118.248 12.7715 118.248 12.0596V10.5654H119.127C119.733 10.5654 120.094 10.1875 120.094 9.63379C120.094 9.08887 119.733 8.70215 119.136 8.70215H118.248V1.81152C118.248 0.756836 117.554 0.141602 116.385 0.141602C115.453 0.141602 114.899 0.52832 114.073 1.75879C112.553 3.99121 111.111 6.16211 110.224 7.75293C109.872 8.38574 109.731 8.79883 109.731 9.29102C109.731 10.0469 110.268 10.5654 111.085 10.5654H116.086V12.0596C116.086 12.7715 116.543 13.1758 117.167 13.1758ZM116.121 8.75488H111.788V8.69336C112.816 6.82129 114.073 4.92285 116.086 2.04004H116.121V8.75488Z",fill:"var(--ck-body-color)"}),(0,F.jsx)("path",{d:"M126.105 13.2549C128.918 13.2549 130.869 11.4355 130.869 8.78125C130.869 6.35547 129.138 4.6416 126.712 4.6416C125.438 4.6416 124.392 5.13379 123.855 5.9248H123.812L124.146 2.17188H129.27C129.85 2.17188 130.228 1.80273 130.228 1.24023C130.228 0.686523 129.85 0.317383 129.27 0.317383H123.803C122.81 0.317383 122.3 0.72168 122.221 1.72363L121.816 6.51367C121.808 6.56641 121.808 6.60156 121.808 6.6543C121.79 7.26953 122.15 7.78809 122.88 7.78809C123.398 7.78809 123.618 7.67383 124.146 7.14648C124.629 6.67188 125.323 6.34668 126.123 6.34668C127.617 6.34668 128.681 7.38379 128.681 8.84277C128.681 10.3457 127.617 11.4092 126.114 11.4092C124.893 11.4092 124.049 10.8027 123.618 9.77441C123.381 9.30859 123.091 9.12402 122.616 9.12402C122.019 9.12402 121.641 9.49316 121.641 10.082C121.641 10.4072 121.72 10.6709 121.843 10.9434C122.467 12.3232 124.154 13.2549 126.105 13.2549Z",fill:"var(--ck-body-color)"})]}),t$=({layoutId:e})=>(0,F.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[(0,F.jsx)(z.E.div,{initial:{rotate:90,scale:.2,x:"100%"},animate:{rotate:0,scale:1,x:0},exit:{rotate:40,scale:.1,x:"70%"},style:{zIndex:4,position:"relative",display:"flex",alignItems:"center",justifyContent:"center",width:76,height:76,background:"var(--ck-graphic-secondary-background, #6366F1)",borderRadius:"50%",boxShadow:"var(--ck-graphic-secondary-box-shadow, 0px 2px 10px rgba(99, 102, 241, 0.3))"},children:tJ}),(0,F.jsx)(tV,{layoutId:e,style:{position:"relative",zIndex:10,margin:"0 -8px",width:112,height:112},children:(0,F.jsxs)(tY,{style:{background:"var(--ck-graphic-primary-background, var(--ck-body-background))",boxShadow:"var(--ck-graphic-primary-box-shadow, 0px 3px 15px rgba(0, 0, 0, 0.1))"},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:[(0,F.jsx)(tG,{}),(0,F.jsx)(z.E.div,{style:{zIndex:2,position:"relative"},children:(0,F.jsx)(tQ,{})})]},"SlideOneInner")},e),(0,F.jsx)(z.E.div,{initial:{rotate:-90,scale:.2,x:"-100%"},animate:{rotate:0,scale:1,x:0},exit:{rotate:-40,scale:.1,x:"-70%"},style:{zIndex:4,position:"relative",width:76,height:76,background:"var(--ck-graphic-secondary-background, #3897FB)",borderRadius:"50%",boxShadow:"var(--ck-graphic-secondary-box-shadow, 0px 2px 10px rgba(56, 151, 251, 0.3))"},children:(0,F.jsx)(tH,{children:(0,F.jsx)("div",{style:{position:"relative",left:-2,top:3},children:tX})})})]}),t1=({layoutId:e})=>(0,F.jsx)(F.Fragment,{children:(0,F.jsxs)("div",{style:{position:"relative",left:-14},children:[(0,F.jsx)(tV,{layoutId:e,style:{zIndex:10,position:"absolute",left:15,top:12,width:32,height:32},children:(0,F.jsx)(tY,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},style:{background:"var(--ck-graphic-primary-background, var(--ck-body-background))",boxShadow:"var(--ck-graphic-primary-box-shadow, 0px 2px 5px rgba(37, 41, 46, 0.16))"},children:(0,F.jsx)(tH,{children:(0,F.jsx)(tQ,{})})},"SlideTwoInner")},e),(0,F.jsxs)(z.E.div,{initial:{scale:.2},animate:{scale:1},exit:{scale:.2},style:{zIndex:7,position:"relative",display:"flex",alignItems:"center",padding:"21px 56px",paddingRight:52,background:"var(--ck-graphic-primary-background, var(--ck-body-background))",boxShadow:"var(--ck-graphic-primary-box-shadow, 0px 2px 9px rgba(0, 0, 0, 0.07))",borderRadius:"var(--ck-border-radius, 16px)"},children:[(0,F.jsx)(tG,{}),(0,F.jsx)("div",{style:{position:"relative",zIndex:2,top:1,left:1},children:tK})]}),(0,F.jsx)(z.E.div,{style:{zIndex:8,position:"absolute",top:-16,right:-28},initial:{rotate:90,x:-70,scale:.4},animate:{rotate:0,x:0,scale:1},exit:{rotate:0,x:-70,scale:.4},children:(0,F.jsx)(tq,{id:e})})]})}),t0=({layoutId:e})=>{let n=Math.random();return(0,F.jsx)(F.Fragment,{children:(0,F.jsxs)(z.E.div,{style:{position:"relative"},children:[(0,F.jsxs)(tV,{layoutId:e,initial:{rotate:80},style:{zIndex:10,position:"relative",width:128,height:128},children:[(0,F.jsx)(tY,{initial:{opacity:0,rotate:100},animate:{opacity:1},exit:{opacity:0},style:{overflow:"hidden",background:`var(--ck-graphic-globe-background, radial-gradient(
              82.42% 82.42% at 50% 86.72%,
              rgba(255, 255, 255, 0.2) 0%,
              rgba(0, 0, 0, 0) 100%
            ),
            linear-gradient(180deg, #3897FB 0%, #5004F1 100%))`,boxShadow:"var(--ck-graphic-globe-box-shadow, 0px -6px 20px rgba(56, 151, 251, 0.23))"},children:(0,F.jsx)(tU,{style:e?void 0:{animationPlayState:"paused"},children:(0,F.jsxs)("svg",{width:"128",height:"128",viewBox:"0 0 128 128",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsxs)("g",{children:[(0,F.jsx)("circle",{cx:"30",cy:"141",r:"64",stroke:`url(#networkRadialA-${n})`,strokeWidth:"3"}),(0,F.jsx)("circle",{cx:"78.8515",cy:"131.123",r:"54.1005",transform:"rotate(-37.4016 78.8515 131.123)",stroke:`url(#networkRadialB-${n})`,strokeWidth:"3"}),(0,F.jsx)("circle",{cx:"63.6053",cy:"2.12794",r:"50.8338",transform:"rotate(134.702 63.6053 2.12794)",stroke:`url(#networkRadialC-${n})`,strokeWidth:"3"}),(0,F.jsx)("circle",{cx:"126.658",cy:"56.6577",r:"50.3433",transform:"rotate(-105 126.658 56.6577)",stroke:`url(#networkRadialD-${n})`,strokeWidth:"3"}),(0,F.jsx)("circle",{cx:"13.6619",cy:"18.9603",r:"46.0247",transform:"rotate(107.362 13.6619 18.9603)",stroke:`url(#networkRadialE-${n})`,strokeWidth:"3"})]}),(0,F.jsxs)("defs",{children:[(0,F.jsxs)("radialGradient",{id:`networkRadialA-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(60.5 84) rotate(104.668) scale(77.0097)",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]}),(0,F.jsxs)("radialGradient",{id:`networkRadialB-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(96.1805 81.6717) rotate(97.125) scale(64.7443)",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]}),(0,F.jsxs)("radialGradient",{id:`networkRadialC-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(96.3816 -36.4455) rotate(114.614) scale(57.7177)",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]}),(0,F.jsxs)("radialGradient",{id:`networkRadialD-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(137.86 7.73234) rotate(92.3288) scale(62.743)",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]}),(0,F.jsxs)("radialGradient",{id:`networkRadialE-${n}`,cx:"0",cy:"0",r:"1",gradientUnits:"userSpaceOnUse",gradientTransform:"translate(35.3203 -21.566) rotate(104.513) scale(54.8617)",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-graphic-globe-lines, white)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-globe-lines, white)",stopOpacity:"0"})]})]})]})})},"SlideThreeInner"),(0,F.jsxs)(z.E.div,{exit:{opacity:0},children:[(0,F.jsx)(z.E.div,{initial:e?void 0:{scale:1.1},animate:e?tD:void 0,transition:{...tR},style:{position:"absolute",inset:0,borderRadius:"50%",boxShadow:"0 0 0 2px var(--ck-graphic-globe-lines, rgba(126, 112, 243, 1))"}},"pulseA"),(0,F.jsx)(z.E.div,{initial:e?void 0:{scale:1.2,opacity:.25},animate:e?tD:void 0,transition:{...tR,delay:.5},style:{position:"absolute",inset:0,borderRadius:"50%",boxShadow:"0 0 0 2px var(--ck-graphic-globe-lines, rgba(126, 112, 243, 1))"}},"pulseB")]})]},e),(0,F.jsxs)(z.E.div,{initial:{rotate:-20,scale:.1,y:-10,x:-10},animate:{rotate:0,scale:1,y:0,x:0},exit:{zIndex:3,scale:.2,y:-25,x:15},style:{zIndex:12,borderRadius:"50%",position:"absolute",bottom:-4,right:-4,width:54,height:54,display:"flex",alignItems:"center",justifyContent:"center",padding:13,background:"var(--ck-graphic-compass-background, var(--ck-body-background))",boxShadow:"var(--ck-graphic-compass-box-shadow, 0px 2px 9px rgba(0, 0, 0, 0.15))"},children:[(0,F.jsx)(tG,{}),(0,F.jsx)(z.E.div,{style:{zIndex:2,position:"absolute"},initial:{rotate:-170},animate:{rotate:0},exit:{rotate:-180,transition:{duration:0}},transition:{type:"spring",stiffness:6,damping:.9,mass:.2},children:tP})]})]},"SlideThree")})},t2=()=>{var e,n;let t;let o=nZ({}),i=r_(),r=null!==(n=null===(e=i.options)||void 0===e?void 0:e.ethereumOnboardingUrl)&&void 0!==n?n:o.aboutScreen_ctaUrl,[a,s]=(0,O.useState)(!0),[c,l]=(0,O.useState)(0),d=(0,O.useRef)(!1),p=(0,O.useRef)(0),h=[.16,1,.3,1];(0,O.useEffect)(()=>()=>clearInterval(t),[]);let u=()=>{if(v.current){let{overflow:e}=getComputedStyle(v.current);return"visible"!==e}return!1},g=e=>{s(!1),u()?x(e):l(e)},x=e=>{if(v.current){let{offsetWidth:n}=v.current;v.current.scrollLeft=n*e,setTimeout(()=>l(e),100)}},b=()=>{if(!v.current)return;let{offsetWidth:e,scrollLeft:n}=v.current,t=p.current;p.current=n,t-n>-4&&t-n<4&&l(Math.round(n/e))},C=()=>{f()},m=()=>{let{offsetWidth:e,scrollLeft:n}=v.current;l(Math.round(n/e))},f=()=>{d.current=!0,clearTimeout(t)},v=(0,O.useRef)(null);(0,O.useEffect)(()=>{if(v.current)return v.current.addEventListener("scroll",b),v.current.addEventListener("touchmove",C),v.current.addEventListener("touchend",m),()=>{v.current&&(v.current.removeEventListener("scroll",b),v.current.removeEventListener("touchmove",C),v.current.removeEventListener("touchend",m))}},[v]);let k=[(0,F.jsx)(t$,{layoutId:"graphicCircle",duration:600,ease:h}),(0,F.jsx)(t1,{layoutId:"graphicCircle",duration:600,ease:h}),(0,F.jsx)(t0,{layoutId:"graphicCircle",duration:600,ease:h})],w=[(0,F.jsx)(t$,{duration:600,ease:h}),(0,F.jsx)(t1,{duration:600,ease:h}),(0,F.jsx)(t0,{duration:600,ease:h})],y=(()=>{var e;switch(null===(e=i.options)||void 0===e?void 0:e.language){case"en-US":case"zh-CN":return 64;default:return 84}})(),j=[(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(e1,{style:{height:24},$small:!0,children:(0,F.jsx)(nX,{children:o.aboutScreen_a_h1})}),(0,F.jsx)(e0,{style:{height:y},children:(0,F.jsx)(nX,{children:o.aboutScreen_a_p})})]}),(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(e1,{style:{height:24},$small:!0,children:(0,F.jsx)(nX,{children:o.aboutScreen_b_h1})}),(0,F.jsx)(e0,{style:{height:y},children:(0,F.jsx)(nX,{children:o.aboutScreen_b_p})})]}),(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(e1,{style:{height:24},$small:!0,children:(0,F.jsx)(nX,{children:o.aboutScreen_c_h1})}),(0,F.jsx)(e0,{style:{height:y},children:(0,F.jsx)(nX,{children:o.aboutScreen_c_p})})]})];return(0,F.jsxs)(eX,{children:[(0,F.jsxs)(tT,{children:[(0,F.jsx)(tI,{children:(0,F.jsx)(D.A,{transition:{duration:.6,ease:h},children:(0,F.jsx)(B.M,{initial:!1,onExitComplete:()=>s(!0),children:k.map((e,n)=>c===n&&(0,F.jsx)(tA,{style:{position:"absolute"},children:e},n))})})}),(0,F.jsx)(tO,{ref:v,children:(0,F.jsx)(B.M,{children:j.map((e,n)=>(0,F.jsxs)(tW,{$active:c===n,children:[(0,F.jsx)(tF,{children:(0,F.jsx)(D.A,{transition:{duration:0},children:(0,F.jsx)(tA,{children:w[n]})})}),(0,F.jsx)(e$,{style:{gap:8,paddingBottom:0},children:e})]},n))})})]}),(0,F.jsx)(n7,{children:(0,F.jsx)(tz,{children:j.map((e,n)=>(0,F.jsx)(tB,{$active:c===n,onClick:()=>{f(),g(n)}},n))})}),(0,F.jsx)(tM,{href:r,arrow:!0,children:o.aboutScreen_ctaText})]})},t3=(0,R.F4)`
...
`,oa=eM.div`
  ...
  ${e=>e.$mobile?(0,R.iv)`
          ...
          ${on} {
            flex-shrink: 0;
            width: 80px;
            ${oi.mobile.ConnectorButton}
            ${ot} {
              ${oi.mobile.ConnectorLabel}
              ${or} {
                display: none;
                width: fit-content;
                margin: 0 auto;
        ...
        `:(0,R.iv)`
          ...
          ${on} {
            ${oi.desktop.ConnectorButton}
            ${ot} {
              ${oi.desktop.ConnectorLabel}
            }
            ${oo} {
              ${oi.desktop.ConnectorIcon}
            }
          }
        `}
`;function os(){var e;let n=(0,h.Z)();return(null!==(e=null==n?void 0:n.chains)&&void 0!==e?e:[]).map(e=>e)}function oc({...e}={}){let n=r_(),{connect:t,connectAsync:o,connectors:i,...r}=(0,u.$)({...e,mutation:{...e.mutation,onError(e){e.message?"User rejected request"!==e.message&&n.log(e.message,e):n.log("Could not connect.",e)}}});return{connect:({connector:e,chainId:o,mutation:i})=>{var r;return t({connector:e,chainId:null!=o?o:null===(r=n.options)||void 0===r?void 0:r.initialChainId},i)},connectAsync:async({connector:e,chainId:t,mutation:i})=>{var r;return o({connector:e,chainId:null!=t?t:null===(r=n.options)||void 0===r?void 0:r.initialChainId},i)},connectors:i,...r}}function ol(e){let{chains:n}=(0,h.Z)();return!!e&&n.some(n=>n.id===e)}let od=O.createContext({connect:{getUri:()=>""},dapp:{chains:[]},account:void 0}),op=({enabled:e,children:n})=>{let{uri:t}=function({enabled:e}={enabled:!0}){let{log:n}=r_(),[t,o]=(0,O.useState)(void 0),i=nq("walletConnect"),{isConnected:r}=(0,d.R)(),{connectAsync:a}=oc();return(0,O.useEffect)(()=>{if(e){if(r)o(void 0);else{if(!i||t)return;if(i&&!r)return d(i),n("add wc listeners"),i.emitter.on("message",s),i.emitter.on("disconnect",c),()=>{n("remove wc listeners"),i.emitter.off("message",s),i.emitter.off("disconnect",c)}}}async function s(e){let{type:t,data:i}=e;n("WC Message",t,i),"display_uri"===t&&o(i)}async function c(){n("WC Disconnect"),i&&l(i)}async function l(e){let n=await a({connector:e});return!!n&&n}async function d(e){try{await l(e)}catch(t){n("catch error"),n(t),t.code?4001===t.code?(n("error.code - User rejected"),d(e)):n("error.code - Unknown Error"):n("WalletConnect cannot connect.",t)}}},[e,i,r]),{uri:t}}({enabled:e}),{address:o,chain:i}=(0,d.R)(),r=ol(null==i?void 0:i.id),a=os();return(0,F.jsx)(od.Provider,{value:{connect:{getUri:e=>t},dapp:{chains:a},account:o?{chain:i,chainIsSupported:r,address:o}:void 0},children:n})},oh=()=>O.useContext(od);function ou(){let[e,n]=(0,O.useState)(ef());return(0,O.useEffect)(()=>{let e=()=>{n(ef())};return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]),e}let og=eM.div`
  position: relative;
`,ox=(0,R.F4)`
0%{ opacity:0; }
100%{ opacity:1; }
`,ob=eM.div`
  ...
  span {
    ...
    animation: ${ox} 300ms ease 1000ms both;
...
`,oC=eM.div`
  ...
  ${({$mobile:e,$height:n,$mobileDirection:t})=>e&&"horizontal"===t?(0,R.iv)`
          overflow-x: scroll;
          margin: 0 -24px;
          padding: 0 24px;
...
`,om=()=>(0,F.jsx)("svg",{width:"11",height:"12",viewBox:"0 0 11 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,F.jsx)("path",{d:"M5.49438 1L5.49438 11M5.49438 11L9.5 7M5.49438 11L1.5 7",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round"})}),of=({children:e,height:n,backgroundColor:t,mobileDirection:o})=>{let i=(0,O.useRef)(null),r=(0,O.useRef)(null),a=ou();return(0,O.useEffect)(()=>{let e=i.current;if(!e)return;e.scrollHeight>e.clientHeight&&r.current&&r.current.classList.remove("hide");let n=n=>{let{scrollTop:t,scrollHeight:o,clientHeight:i,scrollLeft:a,scrollWidth:s,clientWidth:c}=n.target;r.current&&t>0&&r.current.classList.add("hide"),0===t&&0===a?e.classList.add("scroll-start"):e.classList.remove("scroll-start"),o-t===i&&s-a===c?e.classList.add("scroll-end"):e.classList.remove("scroll-end")};return e.addEventListener("scroll",n),n({target:e}),()=>{e.removeEventListener("scroll",n)}},[i.current]),(0,F.jsxs)(og,{children:[(0,F.jsx)(oC,{ref:i,$mobile:a,$height:n,$backgroundColor:t,$mobileDirection:o,children:e}),(0,F.jsx)(ob,{ref:r,className:"hide",onClick:()=>{i.current&&i.current.scrollTo({top:i.current.scrollHeight,behavior:"smooth"})},children:(0,F.jsxs)("span",{children:[(0,F.jsx)(om,{})," More Available"]})})]})},ov=eM(z.E.div)`
  display: flex;
  gap: 8px;
  position: relative;
  border-radius: 9px;
...
`,ow=({children:e,error:n,icon:t})=>(0,F.jsxs)(ov,{$error:n,children:[t&&(0,F.jsx)(ok,{children:t}),(0,F.jsx)("div",{children:e})]});ow.displayName="Alert";let oy=()=>{let{storage:e}=(0,h.Z)(),[n,t]=(0,O.useState)(null);return(0,O.useEffect)(()=>{(async()=>{let n=await (null==e?void 0:e.getItem("recentConnectorId"));t(null!=n?n:"")})()},[]),{lastConnectorId:n,updateLastConnectorId:n=>{null==e||e.setItem("recentConnectorId",n)}}},oj=()=>{var e;let n=r_(),t=ou(),o=n0(),{lastConnectorId:i}=oy(),r=n$(),a=nK(),s=o.filter(e=>e.id!==(null==a?void 0:a.id));r&&$()&&(s=s.filter(e=>e.id!==(null==r?void 0:r.id)));let c=(null===(e=n.options)||void 0===e?void 0:e.hideRecentBadge)||"walletConnect"===i?s:[...s.filter(e=>i===e.connector.id),...s.filter(e=>i!==e.connector.id)];return(0,F.jsxs)(of,{mobileDirection:"horizontal",children:[0===c.length&&(0,F.jsx)(ow,{error:!0,children:"No connectors found in ConnectKit config."}),c.length>0&&(0,F.jsx)(oa,{$mobile:t,$totalResults:c.length,children:c.map(e=>(0,F.jsx)(oS,{wallet:e,isRecent:e.id===i},e.id))})]})},oS=({wallet:e,isRecent:n})=>{var t,o,i,r;let{connect:{getUri:a}}=oh(),s=a(),c=ou(),l=r_(),{connect:d}=oc(),p=!e.isInstalled&&c||e.shouldDeeplinkDesktop&&!c?null===(t=e.getWalletConnectDeeplink)||void 0===t?void 0:t.call(e,null!=s?s:""):void 0,h=c&&ek(e.id),u=("safari"===ex()||"ios"===ex())&&ey(e.connector.id);return(h||u)&&(p=void 0),(0,F.jsxs)(on,{type:"button",as:p?"a":void 0,href:p||void 0,disabled:l.route!==rN.CONNECTORS,onClick:p?void 0:()=>{h?l.setRoute(rN.MOBILECONNECTORS):(u&&d({connector:null==e?void 0:e.connector}),l.setRoute(rN.CONNECT),l.setConnector({id:e.id}))},children:[(0,F.jsx)(oo,{"data-small":e.iconShouldShrink,"data-shape":e.iconShape,"data-background":h,children:null!==(o=e.iconConnector)&&void 0!==o?o:e.icon}),(0,F.jsxs)(ot,{children:[c&&null!==(i=e.shortName)&&void 0!==i?i:e.name,!(null===(r=l.options)||void 0===r?void 0:r.hideRecentBadge)&&n&&(0,F.jsx)(or,{children:(0,F.jsx)("span",{children:"Recent"})})]})]})},oE=eM(z.E.div)`
  display: flex;
  align-items: center;
  justify-content: center;
  inset: 0;
...
`,oz=eM.div`
  ...
  ${e=>e.$disabled&&(0,R.iv)`
    ...
    `}
`,oB=eM.div``;function oD(){let{log:e}=r_(),{connectAsync:n,connectors:t}=oc(),[o,i]=(0,O.useState)(!1);return{isOpen:o,open:async()=>{let o=document.createElement("style");o.innerHTML="w3m-modal, wcm-modal{ --wcm-z-index: 2147483647; --w3m-z-index:2147483647; }",document.head.appendChild(o);let r=t.find(e=>ek(e.id));if(r)try{let t=(await r.getProvider()).rpc.projectId,a=(0,I.a)({projectId:t,showQrModal:!0});i(!0);try{await n({connector:a})}catch(n){e("WalletConnect",n)}i(!1),document.head.removeChild(o)}catch(n){e("Could not get WalletConnect provider",n)}else e("No WalletConnect connector available")}}}let oR=eM(z.E.div)`
  ...
  ${e=>e.$clipboard?(0,R.iv)`
        ...
        `}
`,oH=({copied:e,small:n})=>(0,F.jsx)(oR,{$clipboard:e,children:(0,F.jsx)(nj,{style:{transform:n?"scale(1)":"translateX(3px) scale(1.5)",opacity:n||e?1:.3}})}),oZ=eM.div`
...
`,oG=({string:e,children:n,variant:t})=>{let o;let[i,r]=(0,O.useState)(!1),a=()=>{if(!e)return;let n=e.trim();navigator.clipboard&&navigator.clipboard.writeText(n),r(!0),clearTimeout(o),o=setTimeout(()=>r(!1),1e3)};return"button"===t?(0,F.jsx)(tM,{disabled:!e,onClick:a,icon:(0,F.jsx)(oH,{copied:i}),children:n}):(0,F.jsx)(oZ,{onClick:a,$disabled:!e,children:(0,F.jsxs)(oU,{children:[n,(0,F.jsx)(oH,{copied:i,small:!0})]})})},oV=(0,F.jsx)("svg",{width:"60",height:"60",viewBox:"0 0 60 60",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,F.jsx)("path",{d:"M30 42V19M19 30.5H42",stroke:"var(--ck-body-color-muted)",strokeWidth:"3",strokeLinecap:"round"})}),oY=()=>{var e,n;let t=r_(),o=nZ(),{connect:{getUri:i}}=oh(),r=i(),{open:a,isOpen:s}=oD(),c=n0(),l=null!==(e=Object.keys(eE).filter(e=>{let n=eE[e];return!c.find(n=>n.connector.id===e)&&!!n.getWalletConnectDeeplink}))&&void 0!==e?e:[],d=e=>{var n;let t=null===(n=e.getWalletConnectDeeplink)||void 0===n?void 0:n.call(e,r);t&&(window.location.href=t)};return(0,F.jsx)(eX,{style:{width:312},children:(0,F.jsxs)(oB,{children:[(0,F.jsx)(e$,{style:{paddingBottom:0},children:(0,F.jsx)(of,{height:340,children:(0,F.jsxs)(oz,{$disabled:!r,children:[l.sort((e,n)=>{var t,o,i,r;let a=eE[e],s=eE[n],c=null!==(o=null!==(t=a.name)&&void 0!==t?t:a.shortName)&&void 0!==o?o:e,l=null!==(r=null!==(i=s.name)&&void 0!==i?i:s.shortName)&&void 0!==r?r:n;return c.localeCompare(l)}).filter(e=>!("coinbaseWallet"===e||"com.coinbase.wallet"===e)).map((e,n)=>{let t=eE[e],{name:o,shortName:i,iconConnector:r,icon:a}=t;return(0,F.jsxs)(oF,{onClick:()=>d(t),style:{animationDelay:`${50*n}ms`},children:[(0,F.jsx)(oO,{$outline:!0,children:null!=r?r:a}),(0,F.jsx)(oW,{children:null!=i?i:o})]},n)}),(0,F.jsxs)(oF,{onClick:a,$waiting:s,children:[(0,F.jsx)(oO,{style:{background:"var(--ck-body-background-secondary)"},children:s?(0,F.jsx)("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"},children:(0,F.jsx)("div",{style:{width:"50%"},children:(0,F.jsx)(tN,{})})}):oV}),(0,F.jsx)(oW,{children:o.more})]})]})})}),(null===(n=t.options)||void 0===n?void 0:n.walletConnectCTA)!=="modal"&&(0,F.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14,paddingTop:8},children:(0,F.jsx)(oG,{variant:"button",string:r,children:o.copyToClipboard})})]})})},oP=eM(z.E.div)`
  display: flex;
  flex-direction: column;
  gap: 6px;
  position: relative;
...
`,oK=eM(z.E.div)`
  ...
  ${e=>e.$shake&&(0,R.iv)`
      animation: ${oQ} 220ms ease-out both;
      &:before {
...
`,o5=({children:e,message:n,open:t,xOffset:o=0,yOffset:i=0,delay:r})=>{var a;let s=r_(),c=nC();if(null===(a=s.options)||void 0===a?void 0:a.hideTooltips)return(0,F.jsx)(F.Fragment,{children:e});let[l,d]=(0,O.useState)(!1),[p,h]=(0,O.useState)(!1),[u,g]=(0,O.useState)("small"),[x,b]=(0,O.useState)(!1),[C]=(0,O.useState)(s.route),m=(0,O.useRef)(null),[f,v]=(0,G.Z)({debounce:x?0:220,offsetSize:!0,scroll:!0}),k=()=>{let e=!1,n=o+v.left+v.width,t=i+v.top+.5*v.height;return(n>window.innerWidth||n<0||t>window.innerHeight||t<0)&&(e=!0),e};return("undefined"!=typeof window?O.useLayoutEffect:O.useEffect)(()=>{if(!m.current||v.top+v.bottom+v.left+v.right+v.height+v.width===0)return;let e=o+v.left+v.width,n=i+v.top+.5*v.height;x||0===e||0===n||b(!0),m.current.style.left=`${e}px`,m.current.style.top=`${n}px`,g(m.current.offsetHeight<=40?"small":"large"),h(k())},[v,t,l]),(0,O.useEffect)(()=>{s.open||d(!1)},[s.open]),(0,O.useEffect)(()=>{d(!!t)},[t]),(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(z.E.div,{ref:f,style:void 0===t?{cursor:"help"}:{},onHoverStart:()=>d(!0),onHoverEnd:()=>d(!1),onClick:()=>d(!1),children:e}),(0,F.jsx)(eR,{children:(0,F.jsx)(B.M,{children:C===s.route&&!p&&l&&(0,F.jsx)(eD,{$useTheme:c.theme,$useMode:c.mode,$customTheme:c.customTheme,children:(0,F.jsx)(o0,{children:(0,F.jsxs)(o2,{role:"tooltip",$size:u,ref:m,initial:"collapsed",animate:x?"open":{},exit:"collapsed",variants:{collapsed:{transformOrigin:"20px 50%",opacity:0,scale:.9,z:.01,y:"-50%",x:20,transition:{duration:.1}},open:{willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:"-50%",x:20,transition:{ease:[.76,0,.24,1],duration:.15,delay:r||.5}}},children:[n,(0,F.jsx)(o3,{$size:u})]})})})})})]})},o4=eM(z.E.div)`
  z-index: 4;
  position: relative;
  overflow: hidden;
  svg {
...
`,ip=({logo:e,smallLogo:n,connecting:t=!0,unavailable:o=!1,countdown:i=!1})=>(0,F.jsxs)(ia,{transition:{duration:.5,ease:[.175,.885,.32,.98]},children:[(0,F.jsx)(is,{$small:!o&&n,style:o?{borderRadius:0}:void 0,children:e}),(0,F.jsx)(ic,{children:(0,F.jsxs)(B.M,{children:[t&&(0,F.jsx)(id,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,transition:{duration:i?1:0}},children:(0,F.jsxs)("svg",{"aria-hidden":"true",width:"102",height:"102",viewBox:"0 0 102 102",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("path",{d:"M52 100C24.3858 100 2 77.6142 2 50",stroke:"url(#paint0_linear_1943_4139)",strokeWidth:"3.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,F.jsx)("defs",{children:(0,F.jsxs)("linearGradient",{id:"paint0_linear_1943_4139",x1:"2",y1:"48.5",x2:"53",y2:"100",gradientUnits:"userSpaceOnUse",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]})},"Spinner"),i&&(0,F.jsxs)(il,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.25},children:[(0,F.jsx)("div",{}),(0,F.jsx)("div",{})]},"ExpiringSpinner")]})})]}),ih={CONNECTED:"connected",CONNECTING:"connecting",EXPIRING:"expiring",FAILED:"failed",REJECTED:"rejected",NOTCONNECTED:"notconnected",UNAVAILABLE:"unavailable"},iu={initial:{willChange:"transform,opacity",position:"relative",opacity:0,scale:.95},animate:{position:"relative",opacity:1,scale:1,transition:{ease:[.16,1,.3,1],duration:.4,delay:.05,position:{delay:0}}},exit:{position:"absolute",opacity:0,scale:.95,transition:{ease:[.16,1,.3,1],duration:.3}}},ig=({switchConnectMethod:e,forceState:n})=>{var t,o,i,r,a,s,c,l;let d;let{connect:p}=oc({mutation:{onMutate:e=>{e.connector?y(ih.CONNECTING):y(ih.UNAVAILABLE)},onError(e){console.error(e)},onSettled(e,n){if(n){if(m(!0),setTimeout(()=>m(!1),3500),n.code)switch(n.code){case -32002:y(ih.NOTCONNECTED);break;case 4001:y(ih.REJECTED);break;default:y(ih.FAILED)}else n.message&&("User rejected request"===n.message?y(ih.REJECTED):y(ih.FAILED))}setTimeout(h,100)}}}),{triggerResize:h,connector:u}=r_(),g=u.id,x=n1(g),b={name:null==x?void 0:x.name,shortName:null!==(t=null==x?void 0:x.shortName)&&void 0!==t?t:null==x?void 0:x.name,icon:null!==(o=null==x?void 0:x.iconConnector)&&void 0!==o?o:null==x?void 0:x.icon,iconShape:null!==(i=null==x?void 0:x.iconShape)&&void 0!==i?i:"circle",iconShouldShrink:null==x?void 0:x.iconShouldShrink},[C,m]=(0,O.useState)(!1);(0,O.useState)(9);let f=ex(),v=null===(r=null==x?void 0:x.downloadUrls)||void 0===r?void 0:r[f],k=(null==x?void 0:x.downloadUrls)?{name:Object.keys(null==x?void 0:x.downloadUrls)[0],label:(null===(a=Object.keys(null==x?void 0:x.downloadUrls)[0])||void 0===a?void 0:a.charAt(0).toUpperCase())+(null===(s=Object.keys(null==x?void 0:x.downloadUrls)[0])||void 0===s?void 0:s.slice(1)),url:null==x?void 0:x.downloadUrls[Object.keys(null==x?void 0:x.downloadUrls)[0]]}:void 0,[w,y]=(0,O.useState)(n||((null==x?void 0:x.isInstalled)?ih.CONNECTING:ih.UNAVAILABLE)),j=nZ({CONNECTORNAME:b.name,CONNECTORSHORTNAME:null!==(c=b.shortName)&&void 0!==c?c:b.name,SUGGESTEDEXTENSIONBROWSER:null!==(l=null==k?void 0:k.label)&&void 0!==l?l:"your browser"}),S=async()=>{(null==x?void 0:x.isInstalled)&&(null==x?void 0:x.connector)?p({connector:null==x?void 0:x.connector}):y(ih.UNAVAILABLE)};return((0,O.useEffect)(()=>{if(w!==ih.UNAVAILABLE)return d=setTimeout(S,600),()=>{clearTimeout(d)}},[]),x)?ek(null==x?void 0:x.connector.id)?(0,F.jsx)(eX,{children:(0,F.jsxs)(oJ,{children:[(0,F.jsx)(eq,{children:"Invalid State"}),(0,F.jsx)(e$,{children:(0,F.jsx)(ow,{children:"WalletConnect does not have an injection flow. This state should never happen."})})]})}):(0,F.jsx)(eX,{children:(0,F.jsxs)(oJ,{children:[(0,F.jsx)(oq,{children:(0,F.jsxs)(oK,{$shake:w===ih.FAILED||w===ih.REJECTED,$circle:"circle"===b.iconShape,children:[(0,F.jsx)(B.M,{children:(w===ih.FAILED||w===ih.REJECTED)&&(0,F.jsx)(o$,{"aria-label":"Retry",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileTap:{scale:.9},transition:{duration:.1},onClick:S,children:(0,F.jsx)(o1,{children:(0,F.jsx)(o5,{open:C&&(w===ih.FAILED||w===ih.REJECTED),message:j.tryAgainQuestion,xOffset:-6,children:(0,F.jsx)(nw,{})})})})}),"circle"===b.iconShape?(0,F.jsx)(ip,{logo:w===ih.UNAVAILABLE?(0,F.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:b.icon}):(0,F.jsx)(F.Fragment,{children:b.icon}),smallLogo:b.iconShouldShrink,connecting:w===ih.CONNECTING,unavailable:w===ih.UNAVAILABLE}):(0,F.jsx)(o7,{logo:w===ih.UNAVAILABLE?(0,F.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:b.icon}):(0,F.jsx)(F.Fragment,{children:b.icon}),connecting:w===ih.CONNECTING})]})}),(0,F.jsx)(eK,{children:(0,F.jsxs)(B.M,{initial:!1,children:[w===ih.FAILED&&(0,F.jsxs)(oP,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:[(0,F.jsxs)(e$,{children:[(0,F.jsxs)(e1,{$error:!0,children:[(0,F.jsx)(nf,{}),j.injectionScreen_failed_h1]}),(0,F.jsx)(e0,{children:j.injectionScreen_failed_p})]}),ew(x.id)&&(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(n7,{}),(0,F.jsx)(tM,{onClick:()=>e(g),children:j.connectWithFamilyIOS})]})]},ih.FAILED),w===ih.REJECTED&&(0,F.jsxs)(oP,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:[(0,F.jsxs)(e$,{style:ew(x.connector.id)?{paddingBottom:12}:{paddingBottom:28},children:[(0,F.jsx)(e1,{children:j.injectionScreen_rejected_h1}),(0,F.jsx)(e0,{children:j.injectionScreen_rejected_p})]}),ew(x.id)&&(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(n7,{}),(0,F.jsx)(tM,{onClick:()=>e(g),children:j.connectWithFamilyIOS})]})]},ih.REJECTED),(w===ih.CONNECTING||w===ih.EXPIRING)&&(0,F.jsx)(oP,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:(0,F.jsxs)(e$,{style:{paddingBottom:28},children:[(0,F.jsx)(e1,{children:"injected"===x.connector.id?j.injectionScreen_connecting_injected_h1:j.injectionScreen_connecting_h1}),(0,F.jsx)(e0,{children:"injected"===x.connector.id?j.injectionScreen_connecting_injected_p:j.injectionScreen_connecting_p})]})},ih.CONNECTING),w===ih.CONNECTED&&(0,F.jsx)(oP,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:(0,F.jsxs)(e$,{children:[(0,F.jsxs)(e1,{$valid:!0,children:[(0,F.jsx)(nk,{})," ",j.injectionScreen_connected_h1]}),(0,F.jsx)(e0,{children:j.injectionScreen_connected_p})]})},ih.CONNECTED),w===ih.NOTCONNECTED&&(0,F.jsx)(oP,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:(0,F.jsxs)(e$,{children:[(0,F.jsx)(e1,{children:j.injectionScreen_notconnected_h1}),(0,F.jsx)(e0,{children:j.injectionScreen_notconnected_p})]})},ih.NOTCONNECTED),w===ih.UNAVAILABLE&&(0,F.jsx)(oP,{initial:"initial",animate:"animate",exit:"exit",variants:iu,children:v?(0,F.jsxs)(F.Fragment,{children:[(0,F.jsxs)(e$,{style:{paddingBottom:18},children:[(0,F.jsx)(e1,{children:j.injectionScreen_install_h1}),(0,F.jsx)(e0,{children:j.injectionScreen_install_p})]}),!x.isInstalled&&v&&(0,F.jsx)(tM,{href:v,icon:(0,F.jsx)(ir,{}),children:j.installTheExtension})]}):(0,F.jsxs)(F.Fragment,{children:[(0,F.jsxs)(e$,{style:{paddingBottom:12},children:[(0,F.jsx)(e1,{children:j.injectionScreen_unavailable_h1}),(0,F.jsx)(e0,{children:j.injectionScreen_unavailable_p})]}),!x.isInstalled&&k&&(0,F.jsxs)(tM,{href:null==k?void 0:k.url,icon:(0,F.jsx)(ir,{browser:null==k?void 0:k.name}),children:["Install on ",null==k?void 0:k.label]})]})},ih.UNAVAILABLE)]})})]})}):(0,F.jsx)(eX,{children:(0,F.jsxs)(oJ,{children:[(0,F.jsx)(eq,{children:"Invalid State"}),(0,F.jsx)(e$,{children:(0,F.jsx)(ow,{children:"No connectors match the id given. This state should never happen."})})]})})},ix=eM(z.E.div)`
  z-index: 3;
  position: relative;
  overflow: hidden;
  height: 0;
...
`,ik=eM(z.E.div)`
  ...
  ${e=>e.$wcLogo?(0,R.iv)`
        ...
        `}
`,iw=(e,n)=>{let t=Array.prototype.slice.call(Y.create(e,{errorCorrectionLevel:n}).modules.data,0),o=Math.sqrt(t.length);return t.reduce((e,n,t)=>(t%o==0?e.push([n]):e[e.length-1].push(n))&&e,[])};function iy({ecl:e="M",size:n=200,uri:t,clearArea:o=!1,image:i,imageBackground:r="transparent"}){let a=o?76:0,s=n-20,c=(0,O.useMemo)(()=>{let n=[],o=iw(t,e),c=s/o.length;if([{x:0,y:0},{x:1,y:0},{x:0,y:1}].forEach(({x:e,y:t})=>{let i=(o.length-7)*c*e,r=(o.length-7)*c*t;for(let o=0;o<3;o++)n.push((0,F.jsx)("rect",{fill:o%2!=0?"var(--ck-qr-background, var(--ck-body-background))":"var(--ck-qr-dot-color)",rx:-((o-2)*5)+(0===o?2:3),ry:-((o-2)*5)+(0===o?2:3),width:c*(7-2*o),height:c*(7-2*o),x:i+c*o,y:r+c*o},`${o}-${e}-${t}`))}),i){let e=(o.length-7)*c*1,t=(o.length-7)*c*1;n.push((0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)("rect",{fill:r,rx:12,ry:12,width:7*c,height:7*c,x:e+0*c,y:t+0*c}),(0,F.jsx)("foreignObject",{width:7*c,height:7*c,x:e+0*c,y:t+0*c,children:(0,F.jsx)("div",{style:{borderRadius:12,overflow:"hidden"},children:i})})]}))}let l=Math.floor((a+25)/c),d=o.length/2-l/2,p=o.length/2+l/2-1;return o.forEach((e,t)=>{e.forEach((e,r)=>{o[t][r]&&!(t<7&&r<7||t>o.length-8&&r<7||t<7&&r>o.length-8)&&(i||!(t>d&&t<p&&r>d&&r<p))&&n.push((0,F.jsx)("circle",{cx:t*c+c/2,cy:r*c+c/2,fill:"var(--ck-qr-dot-color)",r:c/3},`circle-${t}-${r}`))})}),n},[e,s,t]);return(0,F.jsxs)("svg",{height:s,width:s,viewBox:`0 0 ${s} ${s}`,style:{width:s,height:s},children:[(0,F.jsx)("rect",{fill:"transparent",height:s,width:s}),c]})}function ij({value:e,image:n,imageBackground:t,imagePosition:o="center",tooltipMessage:i}){let r=function(){let[e,n]=(0,O.useState)({width:0,height:0});return(0,O.useEffect)(()=>{function e(){n({width:window.innerWidth,height:window.innerHeight})}return window.addEventListener("resize",e),e(),()=>window.removeEventListener("resize",e)},[]),e}().width>920&&i?(0,F.jsx)(o5,{xOffset:139,yOffset:5,delay:.1,message:i,children:n}):n;return(0,F.jsx)(ix,{children:(0,F.jsxs)(ib,{children:[n&&(0,F.jsx)(iv,{children:(0,F.jsx)(ik,{$wcLogo:"center"!==o,style:{background:"center"===o?t:void 0},children:r})}),(0,F.jsx)(B.M,{initial:!1,children:e?(0,F.jsx)(z.E.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:(0,F.jsx)(iy,{uri:e,size:288,ecl:"M",clearArea:!!("center"===o&&n)})},e):(0,F.jsxs)(im,{initial:{opacity:.1},animate:{opacity:.1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:[(0,F.jsx)("span",{}),(0,F.jsx)("span",{}),(0,F.jsx)("span",{}),(0,F.jsx)("div",{})]})})]})})}ij.displayName="CustomQRCode";let iS=eM(z.E.div)`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,iE=({logo:e})=>{let n=[(0,F.jsx)(ed.MetaMask,{background:!0}),(0,F.jsx)(ed.Coinbase,{background:!0}),(0,F.jsx)(ed.Crypto,{}),(0,F.jsx)(ed.ImToken,{}),(0,F.jsx)(ed.Argent,{}),(0,F.jsx)(ed.Trust,{})];return(0,F.jsx)(iS,{children:(0,F.jsxs)("svg",{"aria-hidden":"true",width:"47",height:"52",viewBox:"0 0 47 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsxs)("g",{mask:"url(#gradient-mask)",children:[(0,F.jsx)("path",{d:"M7 14.5C7 11.4624 9.46243 9 12.5 9H31.5C34.5376 9 37 11.4624 37 14.5V47H7V14.5Z",fill:"var(--ck-graphic-scaniconwithlogos-04)"}),e?(0,F.jsx)("foreignObject",{x:"13",y:"21",width:"18",height:"18",rx:"5",children:(0,F.jsx)("div",{style:{overflow:"hidden",borderRadius:5},children:e})}):(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)("foreignObject",{x:"12",y:"15",width:"9",height:"9",rx:"2.5",children:(0,F.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[0]})}),(0,F.jsx)("foreignObject",{x:"23",y:"15",width:"9",height:"9",rx:"2.5",children:(0,F.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[1]})}),(0,F.jsx)("foreignObject",{x:"12",y:"26",width:"9",height:"9",rx:"2.5",children:(0,F.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:(0,F.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[2]})})}),(0,F.jsx)("foreignObject",{x:"23",y:"26",width:"9",height:"9",rx:"2.5",children:(0,F.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[3]})}),(0,F.jsx)("foreignObject",{x:"12",y:"37",width:"9",height:"9",rx:"2.5",children:(0,F.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[4]})}),(0,F.jsx)("foreignObject",{x:"23",y:"37",width:"9",height:"9",rx:"2.5",children:(0,F.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:n[5]})})]}),(0,F.jsx)("path",{d:"M36 47V13.7143C36 11.1107 33.8893 9 31.2857 9H12.7143C10.1107 9 8 11.1107 8 13.7143V47",stroke:"url(#paint0_linear_924_12568)",strokeWidth:"2"}),(0,F.jsx)("path",{d:"M15 10H29C29 11.1046 28.1046 12 27 12H17C15.8954 12 15 11.1046 15 10Z",fill:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,F.jsx)("rect",{x:"1",y:"47",width:"43",height:"5",fill:"var(--ck-tooltip-background)"}),(0,F.jsx)("rect",{x:"22",y:"1",width:"24",height:"24",rx:"12",fill:"var(--ck-graphic-scaniconwithlogos-03)",stroke:"var(--ck-tooltip-background)",strokeWidth:"2"}),(0,F.jsx)("rect",{x:"34.5",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,F.jsx)("rect",{x:"31",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,F.jsx)("rect",{x:"31",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,F.jsx)("rect",{x:"34.5",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,F.jsx)("path",{d:"M28.5 10.5V9C28.5 8.17157 29.1716 7.5 30 7.5H31.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,F.jsx)("path",{d:"M36.5 7.5L38 7.5C38.8284 7.5 39.5 8.17157 39.5 9L39.5 10.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,F.jsx)("path",{d:"M39.5 15.5L39.5 17C39.5 17.8284 38.8284 18.5 38 18.5L36.5 18.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,F.jsx)("path",{d:"M31.5 18.5L30 18.5C29.1716 18.5 28.5 17.8284 28.5 17L28.5 15.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})]}),(0,F.jsxs)("defs",{children:[(0,F.jsxs)("linearGradient",{id:"paint0_linear_924_12568",x1:"22",y1:"8.2549",x2:"22",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-scaniconwithlogos-02)"})]}),(0,F.jsxs)("linearGradient",{id:"linear-gradient-mask",x1:"47",y1:"42",x2:"47",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,F.jsx)("stop",{stopColor:"white"}),(0,F.jsx)("stop",{offset:"1",stopColor:"black",stopOpacity:"0"})]}),(0,F.jsx)("mask",{id:"gradient-mask",children:(0,F.jsx)("rect",{x:"0",y:"0",width:"47",height:"52",fill:"url(#linear-gradient-mask)"})})]})]})})},iN=({switchConnectMethod:e})=>{var n,t,o,i,r,a,s,c;let l=r_(),d=l.connector.id,p=n1(l.connector.id),{open:h,isOpen:u}=oD(),{connect:{getUri:g}}=oh(),x=g(d),b=x?null!==(t=null===(n=null==p?void 0:p.getWalletConnectDeeplink)||void 0===n?void 0:n.call(p,x))&&void 0!==t?t:x:void 0,C=nZ({CONNECTORNAME:null==p?void 0:p.name});if(!p)return(0,F.jsxs)(F.Fragment,{children:["Wallet not found ",l.connector.id]});let m=null==p?void 0:p.downloadUrls,f={chrome:null==m?void 0:m.chrome,firefox:null==m?void 0:m.firefox,brave:null==m?void 0:m.brave,edge:null==m?void 0:m.edge,safari:null==m?void 0:m.safari};ex();let v=m&&0!==Object.keys(m).length;f&&(Object.keys(f)[0],null===(o=Object.keys(f)[0])||void 0===o||o.charAt(0).toUpperCase(),null===(i=Object.keys(f)[0])||void 0===i||i.slice(1),f[Object.keys(f)[0]]);let k=ek(d);return(0,F.jsxs)(eX,{children:[(0,F.jsxs)(e$,{style:{paddingBottom:8,gap:14},children:[(0,F.jsx)(ij,{value:b,image:null==p?void 0:p.icon,tooltipMessage:ek(d)?(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(iE,{}),(0,F.jsx)("span",{children:C.scanScreen_tooltip_walletConnect})]}):(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(iE,{logo:null==p?void 0:p.icon}),(0,F.jsx)("span",{children:C.scanScreen_tooltip_default})]})}),k?(0,F.jsx)(n7,{}):v&&(0,F.jsx)(n7,{children:C.dontHaveTheApp})]}),k&&(0,F.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14},children:[(null===(r=l.options)||void 0===r?void 0:r.walletConnectCTA)!=="modal"&&(0,F.jsx)(oG,{variant:"button",string:b,children:(null===(a=l.options)||void 0===a?void 0:a.walletConnectCTA)==="link"?C.copyToClipboard:C.copyCode}),(null===(s=l.options)||void 0===s?void 0:s.walletConnectCTA)!=="link"&&(0,F.jsx)(tM,{icon:(0,F.jsx)(nm,{}),onClick:h,disabled:u,waiting:u,children:(null===(c=l.options)||void 0===c?void 0:c.walletConnectCTA)==="modal"?C.useWalletConnectModal:C.useModal})]}),ew(p.id)&&(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(n7,{}),(0,F.jsx)(tM,{onClick:()=>e(d),children:C.loginWithEmailOrPhone})]}),v&&(0,F.jsx)(F.Fragment,{children:(0,F.jsx)(tM,{onClick:()=>{l.setRoute(rN.DOWNLOAD)},download:!0,children:C.getWalletName})})]})},iL={QRCODE:"qrcode",INJECTOR:"injector"},iM=()=>{let e=r_(),n=n1(e.connector.id),t=!(null==n?void 0:n.isInstalled)&&(null==n?void 0:n.getWalletConnectDeeplink),[o,i]=(0,O.useState)(t?iL.QRCODE:iL.INJECTOR);return((0,O.useEffect)(()=>{let t=async()=>{await (null==n?void 0:n.connector.getProvider())||(i(iL.QRCODE),setTimeout(e.triggerResize,10))};o===iL.INJECTOR&&t()},[]),n)?(0,F.jsxs)(B.M,{children:[o===iL.QRCODE&&(0,F.jsx)(z.E.div,{initial:"initial",animate:"animate",exit:"exit",variants:n9,children:(0,F.jsx)(iN,{switchConnectMethod:n=>{i(iL.INJECTOR),setTimeout(e.triggerResize,10)}})},iL.QRCODE),o===iL.INJECTOR&&(0,F.jsx)(z.E.div,{initial:"initial",animate:"animate",exit:"exit",variants:n9,children:(0,F.jsx)(ig,{switchConnectMethod:n=>{i(iL.QRCODE),setTimeout(e.triggerResize,10)}})},iL.INJECTOR)]}):(0,F.jsxs)(ow,{children:["Connector not found ",e.connector.id]})},i_=()=>{var e,n,t;let o=n1(r_().connector.id),i=nZ({CONNECTORNAME:null==o?void 0:o.name});if(!o)return(0,F.jsx)(F.Fragment,{children:"Wallet not found"});let r={ios:null===(e=o.downloadUrls)||void 0===e?void 0:e.ios,android:null===(n=o.downloadUrls)||void 0===n?void 0:n.android,redirect:null===(t=o.downloadUrls)||void 0===t?void 0:t.download},a=r.ios&&r.android?i.downloadAppScreen_iosAndroid:r.ios?i.downloadAppScreen_ios:i.downloadAppScreen_android;return(0,F.jsx)(eX,{children:(0,F.jsxs)(e$,{style:{paddingBottom:4,gap:14},children:[r.redirect&&(0,F.jsx)(ij,{value:r.redirect}),!r.redirect&&(0,F.jsx)(F.Fragment,{children:"No download link available"}),(0,F.jsx)(e0,{style:{fontSize:15,lineHeight:"20px",padding:"0 12px"},children:a})]})})},iI=eM(z.E.div)`
  padding: 18px 0 20px;
  @media only screen and (max-width: ${eH.mobileWidth}px) {
    padding: 16px 0 20px;
  }
...
`,iz=eM(z.E.div)`
  ...
  &:before {
    ...
    opacity: 0.75;
    background-size: 200% 100%;
    animation: ${iT} 1000ms linear infinite both;
  }
`,iB=eM(z.E.div)`
  ...
  ${e=>{if(e.$seed){let n=Math.ceil(e.$seed.split("").map(e=>e.charCodeAt(0)).reduce((e,n)=>e+n)%100/100*8),t=`0${0===n?1:n}`;return(0,R.iv)`
...
`,i$=eM(z.E.button)`
  ...
  @media only screen and (min-width: ${eH.mobileWidth}px) {
    &:hover {
      &:before {
...
`,i2=(0,F.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M2 16.75C2.69036 16.75 3.25 17.3096 3.25 18V19C3.25 26.5939 9.40609 32.75 17 32.75V35.25C8.02537 35.25 0.75 27.9746 0.75 19V18C0.75 17.3096 1.30964 16.75 2 16.75Z",fill:"url(#paint0_linear_1288_18701)"}),(0,F.jsx)("defs",{children:(0,F.jsxs)("linearGradient",{id:"paint0_linear_1288_18701",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]}),i3=({variant:e})=>{let{connector:n,chain:t}=(0,d.R)(),{chains:o,isPending:i,switchChain:r,error:a}=(0,p.o)(),[s,c]=(0,O.useState)(void 0),l=nZ({}),h=ef(),u=(null==a?void 0:a.code)===4902,g=u||!r,x=e=>{r&&(c(e),r({chainId:e}))},{triggerResize:b}=r_();return(0,F.jsxs)(iP,{style:{marginBottom:void 0!==r?-8:0},children:[(0,F.jsx)(iq,{children:(0,F.jsx)(iK,{children:o.map(o=>{var r;let a={...iY.find(e=>e.id===o.id),...o};return(0,F.jsxs)(i$,{$variant:e,disabled:g||a.id===(null==t?void 0:t.id)||i&&s===a.id,onClick:()=>null==x?void 0:x(a.id),style:{opacity:g&&a.id!==(null==t?void 0:t.id)?.4:void 0},children:[(0,F.jsxs)("span",{style:{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:12,color:a.id===(null==t?void 0:t.id)?"var(--ck-dropdown-active-color, inherit)":"inherit"},children:[(0,F.jsxs)(iX,{children:[(0,F.jsx)(iJ,{initial:{opacity:0},animate:{opacity:i&&s===a.id?1:0},transition:{ease:[.76,0,.24,1],duration:.15,delay:.1},children:(0,F.jsx)(z.E.div,{animate:h&&ey(null==n?void 0:n.id)&&i&&s===a.id?{opacity:[1,0],transition:{delay:4,duration:3}}:{opacity:1},children:i2},`${null==a?void 0:a.id}-${null==a?void 0:a.name}`)}),(0,F.jsx)(iQ,{children:null!==(r=a.logo)&&void 0!==r?r:(0,F.jsx)(iV.UnknownChain,{})})]}),a.name]}),"secondary"!==e&&(0,F.jsx)(i1,{children:(0,F.jsxs)(B.M,{initial:!1,exitBeforeEnter:!0,children:[a.id===(null==t?void 0:t.id)&&(0,F.jsx)(z.E.span,{style:{color:"var(--ck-dropdown-active-color, var(--ck-focus-color))",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4,transition:{duration:.1,delay:0}},transition:{ease:[.76,0,.24,1],duration:.3,delay:.2},children:l.connected},"connectedText"),i&&s===a.id&&(0,F.jsx)(z.E.span,{style:{color:"var(--ck-dropdown-pending-color, inherit)",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4},transition:{ease:[.76,0,.24,1],duration:.3,delay:.1},children:(0,F.jsx)(z.E.span,{animate:h&&ey(null==n?void 0:n.id)&&{opacity:[1,0],transition:{delay:4,duration:4}},children:l.approveInWallet})},"approveText")]})}),"secondary"===e?(0,F.jsx)(i0,{initial:!1,animate:{opacity:a.id===(null==t?void 0:t.id)?1:0},transition:{duration:.3,ease:"easeOut"}}):a.id===(null==t?void 0:t.id)&&(0,F.jsx)(i0,{layoutId:"activeChain",layout:"position",transition:{duration:.3,ease:"easeOut"}})]},`${null==a?void 0:a.id}-${null==a?void 0:a.name}`)})})}),(0,F.jsx)(B.M,{children:u&&(0,F.jsx)(z.E.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{ease:[.76,0,.24,1],duration:.3},onAnimationStart:b,onAnimationComplete:b,children:(0,F.jsx)("div",{style:{paddingTop:10,paddingBottom:8},children:(0,F.jsxs)(ow,{children:[l.warnings_walletSwitchingUnsupported," ",l.warnings_walletSwitchingUnsupportedResolve]})})})})]})},i5=eM(z.E.div)`
  z-index: 2147483647;
  position: fixed;
  inset: 0;
`,i4=eM(z.E.div)`
...
`,i8=eM(z.E.div)`
  ...
  user-select: none;
  color: var(--ck-dropdown-color, var(--ck-tooltip-color));
`,i6=({children:e,open:n,onClose:t,offsetX:o=0,offsetY:i=8})=>{var r,a,s;let c=r_(),l=nC(),d=nZ(),[p,h]=(0,O.useState)({x:0,y:0});nh(n);let u=(0,O.useRef)(null);(0,O.useEffect)(()=>{let e=e=>{var o,i,r;if(n&&("Escape"===e.key&&t(),"ArrowDown"===e.key||"ArrowUp"===e.key)){if(!u.current)return;e.preventDefault();let n=null===(o=u.current)||void 0===o?void 0:o.querySelectorAll(`
            a[href]:not(:disabled),
            button:not(:disabled),
            textarea:not(:disabled),
            input[type="text"]:not(:disabled),
            ...
            input[type="checkbox"]:not(:disabled),
            select:not(:disabled)
          `),t=n[0],a=n[n.length-1];if("ArrowUp"===e.key){if(document.activeElement===t)a.focus();else{let e=null===(i=null==document?void 0:document.activeElement)||void 0===i?void 0:i.previousSibling;for(e||(e=a);e.disabled;)e=e.previousSibling;e.focus()}}else if(document.activeElement===a)t.focus();else{let e=null===(r=null==document?void 0:document.activeElement)||void 0===r?void 0:r.nextSibling;for(e||(e=t);e.disabled;)e=e.nextSibling;e.focus()}}};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}},[n]);let g=(0,O.useRef)(null),x=(0,O.useCallback)(e=>{e&&(g.current=e,m())},[n]),[b,C]=(0,G.Z)({debounce:120,offsetSize:!0,scroll:!0}),m=()=>{if(!g.current||C.top+C.bottom+C.left+C.right+C.height+C.width===0)return;let e=C.left+o,n=C.top+C.height+i;g.current.style.left=`${e}px`,g.current.style.top=`${n}px`};return("undefined"!=typeof window?O.useLayoutEffect:O.useEffect)(m,[g.current,C,n]),(0,O.useEffect)(m,[n,g.current]),(0,O.useEffect)(()=>(m(),window.addEventListener("scroll",t),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t)}),[]),(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)("div",{ref:b,children:e}),(0,F.jsx)(B.M,{children:n&&(0,F.jsx)(eR,{children:(0,F.jsx)(eD,{$useTheme:null!==(r=l.theme)&&void 0!==r?r:c.theme,$useMode:null!==(a=l.mode)&&void 0!==a?a:c.mode,$customTheme:null!==(s=l.customTheme)&&void 0!==s?s:c.customTheme,children:(0,F.jsx)(nu,{children:(0,F.jsxs)(i5,{ref:u,children:[(0,F.jsx)(i4,{onClick:t}),(0,F.jsxs)(i9,{ref:x,style:{left:p.x,top:p.y},initial:"collapsed",animate:"open",exit:"collapsed",variants:{collapsed:{transformOrigin:"0 0",opacity:0,scale:.96,z:.01,y:-4,x:0,transition:{duration:.1}},open:{transformOrigin:"0 0",willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:0,x:0,transition:{ease:[.76,0,.24,1],duration:.15}}},children:[(0,F.jsx)(i8,{children:d.switchNetworks}),(0,F.jsx)(i3,{})]})]})})})})})]})},i7=eM.div`
  --bg: transparent;
  --color: #333;
  ${e=>"string"==typeof e.size?(0,R.iv)`
          --width: ${e.size};
          --height: ${e.size};
        `:(0,R.iv)`
        ...
        `};
  ${e=>"string"==typeof e.radius?(0,R.iv)`
          --radius: ${e.radius};
        `:(0,R.iv)`
...
`,ri=(0,F.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.3592 30.1654C10.0472 29.4491 8.85718 28.524 7.83713 27.424C6.81708 26.324 5.98425 25.0677 5.36889 23.7054C5.20157 23.335 5.05033 22.9567 4.91578 22.5717C4.51465 21.4237 4.26735 20.2308 4.17794 19.0239C4.16599 18.8626 4.13894 18.7041 4.09809 18.5507C3.85023 17.6197 3.09399 16.8738 2.11531 16.7999C0.975331 16.7138 -0.0310983 17.5702 0.0141657 18.7125C0.0223289 18.9185 0.0340286 19.1243 0.049253 19.3298C0.165374 20.8971 0.486545 22.4464 1.00749 23.9373C1.10424 24.2142 1.20764 24.4884 1.31755 24.7596C2.13617 26.7799 3.31595 28.6371 4.80146 30.239C6.28696 31.841 8.04998 33.1573 10.0029 34.1258C10.2651 34.2558 10.5307 34.3796 10.7995 34.4969C12.247 35.1287 13.7676 35.5656 15.3217 35.7995C15.5255 35.8301 15.7298 35.8573 15.9346 35.881C17.0703 36.0122 18.0001 35.0731 18.0001 33.9299C18.0001 32.9484 17.3133 32.1381 16.4036 31.8208C16.2537 31.7685 16.0977 31.7296 15.9377 31.7056C14.7411 31.5255 13.5702 31.1891 12.4556 30.7026C12.0818 30.5394 11.716 30.3601 11.3592 30.1654Z",fill:"url(#paint0_linear_1288_1870)"}),(0,F.jsx)("defs",{children:(0,F.jsxs)("linearGradient",{id:"paint0_linear_1288_1870",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,F.jsx)("stop",{stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0.7"}),(0,F.jsx)("stop",{offset:"1",stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0"})]})})]}),rr=({id:e,unsupported:n,radius:t="50%",size:o=24})=>{var i;let r=ol(e),a=iY.find(n=>n.id===e);return iR()?(0,F.jsx)(i7,{size:o,radius:t,children:(0,F.jsxs)(B.M,{initial:!1,children:[(null!=n?n:!r)&&(0,F.jsx)(ro,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,F.jsxs)("svg",{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,F.jsx)("path",{d:"M2.61317 11.2501H9.46246C10.6009 11.2501 11.3256 10.3506 11.3256 9.3549C11.3256 9.05145 11.255 8.73244 11.0881 8.43303L7.65903 2.14708C7.659 2.14702 7.65897 2.14696 7.65893 2.1469C7.65889 2.14682 7.65884 2.14673 7.65879 2.14664C7.31045 1.50746 6.6741 1.17871 6.04 1.17871C5.41478 1.17871 4.763 1.50043 4.41518 2.14968L0.993416 8.43476C0.828865 8.72426 0.75 9.04297 0.75 9.3549C0.75 10.3506 1.47471 11.2501 2.61317 11.2501Z",fill:"currentColor",stroke:"var(--ck-body-background, #fff)",strokeWidth:"1.5"}),(0,F.jsx)("path",{d:"M6.03258 7.43916C5.77502 7.43916 5.63096 7.29153 5.62223 7.02311L5.55675 4.96973C5.54802 4.69684 5.74446 4.5 6.02821 4.5C6.3076 4.5 6.51277 4.70131 6.50404 4.9742L6.43856 7.01864C6.42546 7.29153 6.2814 7.43916 6.03258 7.43916ZM6.03258 9.11676C5.7401 9.11676 5.5 8.9065 5.5 8.60677C5.5 8.30704 5.7401 8.09678 6.03258 8.09678C6.32506 8.09678 6.56515 8.30256 6.56515 8.60677C6.56515 8.91097 6.32069 9.11676 6.03258 9.11676Z",fill:"white"})]})}),e?(0,F.jsx)(re,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:null!==(i=null==a?void 0:a.logo)&&void 0!==i?i:(0,F.jsx)(iV.UnknownChain,{})},`${null==a?void 0:a.id}-${null==a?void 0:a.name}-${e}`):(0,F.jsx)(rt,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:ri},"loading")]})}):(0,F.jsx)("div",{style:{width:o,height:o}})},ra=eM(z.E.div)``,rs=eM(z.E.button)`
  ...
  ${e=>e.disabled?(0,R.iv)`
        ...
        `}
`,rc=({...e})=>(0,F.jsx)("svg",{"aria-hidden":"true",width:"11",height:"6",viewBox:"0 0 11 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,F.jsx)("path",{d:"M1.5 1L5.5 5L9.5 1",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),rl=()=>{let e=r_(),[n,t]=(0,O.useState)(!1),{chain:o}=(0,d.R)(),{chains:i}=(0,p.o)(),r=nZ({CHAIN:null==o?void 0:o.name}),a=ef()||(null==window?void 0:window.innerWidth)<eH.mobileWidth;(0,O.useEffect)(()=>{e.open||t(!1)},[e.open]);let s=i.length<=1;return(0,F.jsx)(F.Fragment,{children:(0,F.jsx)(ra,{children:(0,F.jsx)(i6,{offsetX:-12,open:!a&&n,onClose:()=>t(!1),children:(0,F.jsxs)(rs,{"aria-label":ev(r.switchNetworks).toString(),disabled:s,onClick:()=>{a?e.setRoute(rN.SWITCHNETWORKS):t(!n)},children:[s?(0,F.jsx)(o5,{message:r.chainNetwork,xOffset:-6,delay:.01,children:(0,F.jsx)(rr,{id:null==o?void 0:o.id})}):(0,F.jsx)(rr,{id:null==o?void 0:o.id}),!s&&(0,F.jsx)(rc,{style:{top:1,left:-3}})]})})})})},rd=({closeModal:e})=>{var n,t,o;let i=r_(),r=nC(),a=nZ(),{reset:s}=(0,u.$)(),{disconnect:c}=(0,m.q)(),{address:l,isConnected:p,connector:h,chain:g}=(0,d.R)(),x=ew(null==h?void 0:h.id),{data:C}=(0,f.L)({connector:h}),k=iZ(),{data:w}=(0,b.F)({chainId:1,address:l,config:k}),{data:y}=(0,v.K)({address:l}),[j,S]=(0,O.useState)(!1);(0,O.useEffect)(()=>{p||i.setOpen(!1)},[p]),(0,O.useEffect)(()=>{if(j)return e?e():i.setOpen(!1),()=>{c(),s()}},[j,c,s]);let E=["web95","rounded","minimal"].includes(null!==(t=null!==(n=r.theme)&&void 0!==n?n:i.theme)&&void 0!==t?t:"")?"....":void 0;return(0,F.jsxs)(eX,{children:[(0,F.jsxs)(e$,{style:{paddingBottom:22,gap:6},children:[(0,F.jsx)(iI,{children:(0,F.jsxs)(iA,{children:[(0,F.jsx)(iF,{children:(0,F.jsx)(rl,{})}),(0,F.jsx)(iU,{address:l})]})}),(0,F.jsx)(e1,{children:(0,F.jsx)(oG,{string:l,children:null!=w?w:eh(l,E)})}),(null===(o=null==i?void 0:i.options)||void 0===o?void 0:o.hideBalance)?null:(0,F.jsx)(e0,{children:(0,F.jsx)(iO,{children:(0,F.jsxs)(B.M,{exitBeforeEnter:!0,initial:!1,children:[y&&(0,F.jsxs)(iW,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[eg(Number(null==y?void 0:y.formatted))," ",null==y?void 0:y.symbol]},`chain-${null==g?void 0:g.id}`),!y&&(0,F.jsx)(iz,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:"\xa0"})]})})})]}),x&&(0,F.jsx)(F.Fragment,{children:(0,F.jsx)(tM,{onClick:async()=>{try{await (null==C?void 0:C.request({method:"family_switchAccounts",params:[]}))}catch(e){i.log("rpc method family_switchAccounts is not implemented in this connector",e)}},children:a.switchWallets})}),!ej(null==h?void 0:h.id)&&(0,F.jsx)(tM,{onClick:()=>S(!0),icon:x?void 0:(0,F.jsx)(nv,{}),children:a.disconnect})]})},rp=()=>{let{reset:e}=(0,u.$)(),{disconnect:n}=(0,m.q)(),{connector:t,chain:o}=(0,d.R)(),i=ol(null==o?void 0:o.id),r=nZ({});return(0,F.jsx)(eX,{style:{width:278},children:(0,F.jsxs)(e$,{style:{padding:0,marginTop:-10},children:[!i&&(0,F.jsxs)(e0,{children:[r.warnings_chainUnsupported," ",r.warnings_chainUnsupportedResolve]}),(0,F.jsx)("div",{style:{padding:"6px 8px"},children:(0,F.jsx)(i3,{variant:"secondary"})}),!i&&!ej(null==t?void 0:t.id)&&(0,F.jsxs)("div",{style:{paddingTop:12},children:[(0,F.jsx)(n7,{}),(0,F.jsx)(tM,{icon:(0,F.jsx)(nv,{}),variant:"secondary",onClick:()=>{n(),e()},children:r.disconnect})]})]})})},rh=(0,R.F4)`
  from{ transform: rotate(0deg); }
  to{   transform: rotate(360deg); }
`,ru=(0,R.F4)`
...
`,rm=eM(z.E.div)`
  ...
  &:after {
    ...
    margin-left: -60px;
    transition: inherit;
    animation: ${ru} 10s linear infinite;
    background: linear-gradient(
      90deg,
      var(--border-color),
      var(--border-color) 50%,
  ...
  ${({$connected:e})=>e&&(0,R.iv)`
    ...
    `};
`,rf=({showSignOutButton:e,onSignIn:n,onSignOut:t})=>{let o=iR(),i=nZ(),{setOpen:r}=rF(),{isSignedIn:a,isReady:s,isLoading:c,isRejected:l,isSuccess:p,isError:h,signIn:u,signOut:g,error:x}=nN({onSignIn:e=>null==n?void 0:n(e),onSignOut:()=>null==t?void 0:t()}),{address:b}=(0,d.R)();return o?e&&a?(0,F.jsx)(tM,{style:{margin:0},onClick:g,icon:(0,F.jsx)(nv,{}),children:i.signOut},"button"):b?(0,F.jsx)(tM,{style:{margin:0},arrow:!a&&!c&&!l,onClick:c||p?void 0:u,disabled:c,waiting:c,icon:l&&(0,F.jsx)(z.E.div,{initial:{rotate:-270},animate:{rotate:0},transition:{duration:1,ease:[.175,.885,.32,.98]},children:(0,F.jsx)(ny,{style:{opacity:.4}})}),children:p?i.signedIn:l?i.tryAgain:c?i.awaitingConfirmation:h?null!=x?x:"Unknown Error":i.signIn},"button"):(0,F.jsx)(tM,{style:{margin:0},onClick:()=>r(!0),arrow:!0,children:i.walletNotConnected},"button"):(0,F.jsx)(tM,{style:{margin:0},disabled:!0},"loading")},rv=({src:e,alt:n,width:t,height:o})=>{let i=(0,O.useRef)(null),[r,a]=(0,O.useState)(!0);return(0,O.useEffect)(()=>{i.current&&i.current.complete&&0!==i.current.naturalHeight||a(!1)},[e]),(0,F.jsx)("div",{style:{width:t,height:o,background:"rgba(0,0,0,0.02)",boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.02)"},children:(0,F.jsx)("img",{ref:i,src:e,alt:n,width:t,height:o,onLoad:()=>a(!0),style:{transition:"opacity 0.2s ease",opacity:r?1:0}})})},rk={duration:.2,ease:[.26,.08,.25,1]},rw={duration:.16,ease:[.26,.08,.25,1]},ry=()=>{var e,n;let t=r_(),{isSignedIn:o,reset:i}=nN(),r=ef(),[a,s]=(0,O.useState)(o?"signedIn":"signedOut"),c=nZ({}),l="signedIn"===a?{heading:c.signInWithEthereumScreen_signedIn_heading,h1:c.signInWithEthereumScreen_signedIn_h1,p:c.signInWithEthereumScreen_signedIn_p,button:c.signInWithEthereumScreen_signedIn_button}:{heading:c.signInWithEthereumScreen_signedOut_heading,h1:c.signInWithEthereumScreen_signedOut_h1,p:c.signInWithEthereumScreen_signedOut_p,button:c.signInWithEthereumScreen_signedOut_button};(0,O.useEffect)(()=>{o&&s("signedIn")},[]),(0,O.useEffect)(()=>{o||s("signedOut")},[o]);let{address:p}=(0,d.R)(),h=(()=>{let e={svg:null,default:null};return Array.from(document.getElementsByTagName("link")).forEach(n=>{("icon"===n.getAttribute("rel")||"shortcut icon"===n.getAttribute("rel"))&&n.getAttribute("href")&&("image/svg+xml"===n.getAttribute("type")?e.svg=n.getAttribute("href"):e.default=n.getAttribute("href"))}),e})(),u=null!==(n=null!==(e=J())&&void 0!==e?e:h.svg)&&void 0!==n?n:h.default;return(0,F.jsx)(eX,{style:{width:278},children:(0,F.jsxs)(e$,{style:{padding:0,marginTop:-10},children:[(0,F.jsx)(rg,{children:(0,F.jsx)(B.M,{exitBeforeEnter:!0,children:(0,F.jsx)(z.E.div,{initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:rw,children:(0,F.jsx)(e0,{style:{height:42},children:(0,F.jsx)(nX,{children:l.h1})})},ev(l.h1).toString())})}),(0,F.jsxs)(rm,{$connected:o,children:[(0,F.jsx)("div",{style:{position:"absolute",inset:0},children:(0,F.jsx)(rC,{width:"262",height:"134",viewBox:"0 0 262 134",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,F.jsx)(z.E.rect,{x:"0",y:"0",rx:"12",width:"262",height:"134",strokeDasharray:"3 3",animate:{strokeDashoffset:[0,-6]},transition:{duration:.4,ease:"linear",repeat:1/0}})})}),(0,F.jsx)(z.E.div,{initial:!r&&{opacity:0,x:50,scale:.8},animate:{opacity:1,x:0,scale:1},transition:rk,children:(0,F.jsx)(rx,{children:(0,F.jsx)(iU,{address:p,size:64})})},"avatarImage"),(0,F.jsx)(z.E.div,{initial:!r&&{scale:.6},animate:{scale:1},transition:{...rk},children:(0,F.jsx)(rb,{children:(0,F.jsx)(nk,{})})},"tickIcon"),(0,F.jsx)(z.E.div,{initial:!r&&{opacity:0,x:-40,scale:.8},animate:{opacity:1,x:0,scale:1},transition:{...rk},children:(0,F.jsx)(rx,{children:u?(0,F.jsx)(rv,{src:u,alt:"app"}):(0,F.jsx)(iV.UnknownChain,{})})},"appLogo")]},"status"),(0,F.jsx)(B.M,{exitBeforeEnter:!0,children:(0,F.jsx)(z.E.div,{style:{paddingBottom:r?24:12},initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:rw,children:(0,F.jsx)(e0,{style:{height:42,marginTop:-1,marginBottom:-3},children:(0,F.jsx)(nX,{children:l.p})})},ev(l.p).toString())}),(0,F.jsx)(rf,{showSignOutButton:"signedIn"===a,onSignIn:()=>{setTimeout(()=>{t.setOpen(!1)},1e3)}})]})})},rj={},rS=({mode:e="auto",theme:n="auto",customTheme:t=rj,lang:o="en-US"})=>{var i;let r=r_(),{isConnected:a,chain:s}=(0,d.R)(),c=ol(null==s?void 0:s.id),l=!((null===(i=r.options)||void 0===i?void 0:i.enforceSupportedChains)&&a&&!c),p=l&&r.route!==rN.CONNECTORS&&r.route!==rN.PROFILE,h=l&&r.route!==rN.PROFILE,u={onboarding:(0,F.jsx)(t_,{}),about:(0,F.jsx)(t2,{}),download:(0,F.jsx)(i_,{}),connectors:(0,F.jsx)(oA,{}),mobileConnectors:(0,F.jsx)(oY,{}),connect:(0,F.jsx)(iM,{}),profile:(0,F.jsx)(rd,{}),switchNetworks:(0,F.jsx)(rp,{}),signInWithEthereum:(0,F.jsx)(ry,{})};function g(){r.setOpen(!1)}return(0,O.useEffect)(()=>{var e;a?(r.route!==rN.PROFILE||r.route!==rN.SIGNINWITHETHEREUM)&&(!r.signInWithEthereum||(null===(e=r.options)||void 0===e?void 0:e.disableSiweRedirect)?g():r.setRoute(rN.SIGNINWITHETHEREUM)):g()},[a]),(0,O.useEffect)(()=>r.setMode(e),[e]),(0,O.useEffect)(()=>r.setTheme(n),[n]),(0,O.useEffect)(()=>r.setCustomTheme(t),[t]),(0,O.useEffect)(()=>r.setLang(o),[o]),(0,O.useEffect)(()=>{let e=X();if(!e||!r.open)return;let n=document.createElement("meta");return n.setAttribute("property","og:title"),n.setAttribute("content",e),document.head.prepend(n),()=>{document.head.removeChild(n)}},[r.open]),(0,F.jsx)(nb,{theme:n,customTheme:t,mode:e,children:(0,F.jsx)(n8,{open:r.open,pages:u,pageId:r.route,onClose:l?g:void 0,onInfo:h?()=>r.setRoute(rN.ABOUT):void 0,onBack:p?()=>{r.route===rN.SIGNINWITHETHEREUM?r.setRoute(rN.PROFILE):r.route===rN.SWITCHNETWORKS?r.setRoute(rN.PROFILE):r.route===rN.DOWNLOAD?r.setRoute(rN.CONNECT):r.setRoute(rN.CONNECTORS)}:void 0})})},rE=({onConnect:e,onDisconnect:n})=>{(0,k.V)({onConnect:({address:n,connector:t,isReconnected:o})=>{o||null==e||e({address:n,connectorId:null==t?void 0:t.id})},onDisconnect:()=>null==n?void 0:n()})},rN={ONBOARDING:"onboarding",ABOUT:"about",CONNECTORS:"connectors",MOBILECONNECTORS:"mobileConnectors",CONNECT:"connect",DOWNLOAD:"download",PROFILE:"profile",SWITCHNETWORKS:"switchNetworks",SIGNINWITHETHEREUM:"signInWithEthereum"},rL=(0,O.createContext)(null),rM=({children:e,theme:n="auto",mode:t="auto",customTheme:o,options:i,onConnect:r,onDisconnect:a,debugMode:s=!1})=>{var c,l,p,h;if(!O.useContext(w.V))throw Error("ConnectKitProvider must be within a WagmiProvider");if(O.useContext(rL))throw Error("Multiple, nested usages of ConnectKitProvider detected. Please use only one.");rE({onConnect:r,onDisconnect:a});let u=os(),g=nq("injected"),x=Object.assign({},{language:"en-US",hideBalance:!1,hideTooltips:!1,hideQuestionMarkCTA:!1,hideNoWalletCTA:!1,walletConnectCTA:"link",hideRecentBadge:!1,avoidLayoutShift:!0,embedGoogleFonts:!1,truncateLongENSAddress:!0,walletConnectName:void 0,reducedMotion:!1,disclaimer:null,bufferPolyfill:!0,customAvatar:void 0,initialChainId:null===(c=null==u?void 0:u[0])||void 0===c?void 0:c.id,enforceSupportedChains:!1,ethereumOnboardingUrl:void 0,walletOnboardingUrl:void 0,disableSiweRedirect:!1},i);"undefined"!=typeof window&&x.bufferPolyfill&&(window.Buffer=null!==(l=window.Buffer)&&void 0!==l?l:T.lW);let[b,C]=(0,O.useState)(n),[m,f]=(0,O.useState)(t),[v,k]=(0,O.useState)(null!=o?o:{}),[y,j]=(0,O.useState)("en-US"),[S,E]=(0,O.useState)(!1),[N,L]=(0,O.useState)({id:""}),[M,_]=(0,O.useState)(rN.CONNECTORS),[I,A]=(0,O.useState)(""),[W,z]=(0,O.useState)(0);x.embedGoogleFonts&&function(e){var n,t;let o=null!==(n=({web95:"Lato",retro:"Nunito",midnight:"Inter",minimal:"Inter",rounded:"Nunito"})[e])&&void 0!==n?n:null;t=null!=o?o:"",(0,O.useEffect)(()=>{if(!t)return;t=t.replace(/ /g,"+");let e=document.createElement("link");e.href="https://fonts.googleapis.com",e.rel="preconnect";let n=document.createElement("link");n.href="https://fonts.gstatic.com",n.rel="preconnect",n.crossOrigin="true";let o=document.createElement("link");return o.href=`https://fonts.googleapis.com/css2?family=${t}:wght@400;500;600&display=swap`,o.rel="stylesheet",document.head.appendChild(e),document.head.appendChild(n),document.head.appendChild(o),()=>{document.head.removeChild(e),document.head.removeChild(n),document.head.removeChild(o)}},[t])}(n),(0,O.useEffect)(()=>C(n),[n]),(0,O.useEffect)(()=>j(x.language||"en-US"),[x.language]),(0,O.useEffect)(()=>A(null),[M,S]);let{chain:B,isConnected:D}=(0,d.R)(),H=ol(null==B?void 0:B.id);(0,O.useEffect)(()=>{D&&x.enforceSupportedChains&&!H&&(E(!0),_(rN.SWITCHNETWORKS))},[D,H,B,M,S]),(0,O.useEffect)(()=>{$()&&(null==g||g.connect())},[g]);let Z=s?console.log:()=>{},U={theme:b,setTheme:C,mode:m,setMode:f,customTheme:o,setCustomTheme:k,lang:y,setLang:j,open:S,setOpen:E,route:M,setRoute:_,connector:N,setConnector:L,signInWithEthereum:null!==(h=null===(p=O.useContext(nE))||void 0===p?void 0:p.enabled)&&void 0!==h&&h,onConnect:r,options:x,errorMessage:I,debugMode:s,log:Z,displayError:(e,n)=>{A(e),console.log("---------CONNECTKIT DEBUG---------"),console.log(e),n&&console.table(n),console.log("---------/CONNECTKIT DEBUG---------")},resize:W,triggerResize:()=>z(e=>e+1)};return(0,O.createElement)(rL.Provider,{value:U},(0,F.jsx)(F.Fragment,{children:(0,F.jsx)(op,{enabled:S,children:(0,F.jsxs)(R.f6,{theme:eL,children:[e,(0,F.jsx)(rS,{lang:y,theme:b,mode:t,customTheme:v})]})})}))},r_=()=>{let e=O.useContext(rL);if(!e)throw Error("ConnectKit Hook must be inside a Provider.");return e},rI={disconnected:[rN.CONNECTORS,rN.ABOUT,rN.ONBOARDING,rN.MOBILECONNECTORS,rN.ONBOARDING],connected:[rN.PROFILE,rN.SWITCHNETWORKS,rN.SIGNINWITHETHEREUM]},rA=[...rI.connected,...rI.disconnected],rF=({onConnect:e,onDisconnect:n}={})=>{let t=r_();rE({onConnect:e,onDisconnect:n});let{isConnected:o}=(0,d.R)(),{signIn:i}=nN(),r=()=>{t.setOpen(!1)},a=()=>{t.setOpen(!0)},s=e=>{let n=e;rA.includes(e)?o?rI.connected.includes(e)||(n=rN.PROFILE,t.log(`Route ${e} is not a valid route when connected, navigating to ${n} instead.`)):rI.disconnected.includes(e)||(n=rN.CONNECTORS,t.log(`Route ${e} is not a valid route when disconnected, navigating to ${n} instead.`)):(n=o?rN.PROFILE:rN.CONNECTORS,t.log(`Route ${e} is not a valid route, navigating to ${n} instead.`)),t.setRoute(n),a()};return{open:t.open,setOpen:e=>{e?s(o?rN.PROFILE:rN.CONNECTORS):r()},openAbout:()=>s(rN.ABOUT),openOnboarding:()=>s(rN.ONBOARDING),openProfile:()=>s(rN.PROFILE),openSwitchNetworks:()=>s(rN.SWITCHNETWORKS),openSIWE:e=>{s(rN.SIGNINWITHETHEREUM),e&&i()}}},rO=eM(z.E.div)`
  top: 0;
  bottom: 0;
  left: 0;
  display: inline-flex;
...
`,rD=({children:e,variant:n="primary",autoSize:t=!0,duration:o=.3,style:i})=>{let[r,a]=(0,G.Z)();return(0,F.jsx)(rz,{className:n,initial:!1,animate:t?{width:a.width>10?a.width:"auto"}:void 0,transition:{duration:o,ease:[.25,1,.5,1],delay:.01},style:i,children:(0,F.jsx)("div",{ref:r,style:{whiteSpace:"nowrap",width:"fit-content",position:"relative",padding:"0 12px"},children:e})})},rR=eM(z.E.div)`
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
...
`,rZ=eM.div`
  ...
  span {
    ...
    border-radius: 4px;
    background: currentColor;
    animation: ${rH} 1000ms ease infinite both;
  }
`,rU=({hideIcon:e,hideSymbol:n})=>{let t=iR(),[o,i]=(0,O.useState)(!0),{address:r,chain:a}=(0,d.R)();os();let s=ol(null==a?void 0:a.id),c=(0,Z.NL)(),{data:l}=(0,y.O)({watch:!0}),{data:p,queryKey:h}=(0,v.K)({address:r,chainId:null==a?void 0:a.id});(0,O.useEffect)(()=>{(null==l||l)&&c.invalidateQueries({queryKey:h})},[l,h]);let u=iY.find(e=>e.id===(null==a?void 0:a.id)),g=`${t&&(null==p?void 0:p.formatted)!==void 0?`balance-${null==u?void 0:u.id}-${null==p?void 0:p.formatted}`:"balance-loading"}`;return(0,O.useEffect)(()=>{i(!1)},[]),(0,F.jsx)("div",{style:{position:"relative"},children:(0,F.jsx)(B.M,{initial:!1,children:(0,F.jsx)(z.E.div,{initial:(null==p?void 0:p.formatted)!==void 0&&o?{opacity:1}:{opacity:0,position:"absolute",top:0,left:0,bottom:0},animate:{opacity:1,position:"relative"},exit:{opacity:0,position:"absolute",top:0,left:0,bottom:0},transition:{duration:.4,ease:[.25,1,.5,1],delay:.4},children:r&&t&&(null==p?void 0:p.formatted)!==void 0?s?(0,F.jsxs)(rR,{children:[!e&&(0,F.jsx)(rr,{id:null==a?void 0:a.id}),(0,F.jsx)("span",{style:{minWidth:32},children:eg(Number(null==p?void 0:p.formatted))}),!n&&` ${null==p?void 0:p.symbol}`]}):(0,F.jsxs)(rR,{children:[!e&&(0,F.jsx)(rr,{id:null==a?void 0:a.id}),(0,F.jsx)("span",{style:{minWidth:32},children:"???"})]}):(0,F.jsxs)(rR,{children:[!e&&(0,F.jsx)(rr,{id:null==a?void 0:a.id}),(0,F.jsx)("span",{style:{minWidth:32},children:(0,F.jsxs)(rZ,{children:[(0,F.jsx)("span",{style:{animationDelay:"0ms"}}),(0,F.jsx)("span",{style:{animationDelay:"50ms"}}),(0,F.jsx)("span",{style:{animationDelay:"100ms"}})]})})]})},g)})})},rG={initial:{zIndex:2,opacity:0,x:"-100%"},animate:{opacity:1,x:.1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,opacity:0,x:"-100%",pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},rV={initial:{zIndex:2,opacity:0,x:"100%"},animate:{x:.2,opacity:1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,x:"100%",opacity:0,pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},rY={initial:{opacity:0},animate:{opacity:1,transition:{duration:.3,ease:[.25,1,.5,1]}},exit:{position:"absolute",opacity:0,transition:{duration:.3,ease:[.25,1,.5,1]}}},rP=({children:e})=>{let n=iR(),t=r_(),{open:o,setOpen:i}=rF(),{address:r,isConnected:a,chain:s}=(0,d.R)(),c=ol(null==s?void 0:s.id),l=iZ(),{data:p}=(0,b.F)({chainId:1,address:r,config:l});return e&&n?(0,F.jsx)(F.Fragment,{children:e({show:function(){i(!0),t.setRoute(a?rN.PROFILE:rN.CONNECTORS)},hide:function(){i(!1)},chain:s,unsupported:!c,isConnected:!!r,isConnecting:o,address:r,truncatedAddress:r?eh(r):void 0,ensName:null==p?void 0:p.toString()})}):null};function rQ({label:e,showAvatar:n,separator:t}){var o;let i=nZ({}),r=r_(),{isSignedIn:a}=nN(),{address:s,chain:c}=(0,d.R)(),l=ol(null==c?void 0:c.id),p=iZ(),{data:h}=(0,b.F)({chainId:1,address:s,config:p}),u=i.connectWallet;return(0,F.jsx)(B.M,{initial:!1,children:s?(0,F.jsxs)(rO,{initial:"initial",animate:"animate",exit:"exit",variants:rV,style:{height:40},children:[n&&(0,F.jsxs)(rW,{children:[(0,F.jsxs)(B.M,{initial:!1,children:[a&&(0,F.jsx)(z.E.div,{style:{zIndex:2,position:"absolute",bottom:0,right:0},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,F.jsx)(nS,{})}),!l&&(0,F.jsx)(rT,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,F.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,F.jsx)("path",{d:"M1.68831 13.5H12.0764C13.1026 13.5 13.7647 12.7197 13.7647 11.763C13.7647 11.4781 13.6985 11.1863 13.5462 10.9149L8.34225 1.37526C8.02445 0.791754 7.45505 0.5 6.88566 0.5C6.31627 0.5 5.73364 0.791754 5.42246 1.37526L0.225108 10.9217C0.0728291 11.1863 0 11.4781 0 11.763C0 12.7197 0.662083 13.5 1.68831 13.5ZM6.88566 8.8048C6.49503 8.8048 6.27655 8.5809 6.26331 8.1738L6.16399 5.0595C6.15075 4.64562 6.44869 4.34708 6.87904 4.34708C7.30278 4.34708 7.61396 4.6524 7.60071 5.06628L7.5014 8.16701C7.48154 8.5809 7.26305 8.8048 6.88566 8.8048ZM6.88566 11.3492C6.44207 11.3492 6.07792 11.0303 6.07792 10.5757C6.07792 10.1211 6.44207 9.80219 6.88566 9.80219C7.32926 9.80219 7.69341 10.1143 7.69341 10.5757C7.69341 11.0371 7.32264 11.3492 6.88566 11.3492Z",fill:"currentColor"})})})]}),(0,F.jsx)(iU,{size:24,address:s})]}),(0,F.jsx)("div",{style:{position:"relative",paddingRight:n?1:0},children:(0,F.jsx)(B.M,{initial:!1,children:h?(0,F.jsx)(rO,{initial:"initial",animate:"animate",exit:"exit",variants:rY,style:{position:h?"relative":"absolute"},children:(null===(o=r.options)||void 0===o?void 0:o.truncateLongENSAddress)?eu(h,20):h},"ckEnsName"):(0,F.jsxs)(rO,{initial:"initial",animate:"animate",exit:"exit",variants:rY,style:{position:h?"absolute":"relative"},children:[eh(s,t)," "]},"ckTruncatedAddress")})})]},"connectedText"):(0,F.jsx)(rO,{initial:"initial",animate:"animate",exit:"exit",variants:rG,style:{height:40},children:e||u},"connectWalletText")})}function rX({label:e,showBalance:n=!1,showAvatar:t=!0,theme:o,mode:i,customTheme:r,onClick:a}){var s;let c=iR(),l=r_(),{isConnected:p,address:h,chain:u}=(0,d.R)(),g=ol(null==u?void 0:u.id);function x(){l.setOpen(!0),l.setRoute(p?rN.PROFILE:rN.CONNECTORS)}let b=["web95","rounded","minimal"].includes(null!==(s=null!=o?o:l.theme)&&void 0!==s?s:"")?"....":void 0;if(!c)return null;let C=n&&g,m=h&&C;return(0,F.jsx)(eD,{$useTheme:null!=o?o:l.theme,$useMode:null!=i?i:l.mode,$customTheme:null!=r?r:l.customTheme,children:(0,F.jsxs)(rB,{onClick:()=>{a?a(x):x()},children:[C&&(0,F.jsx)(B.M,{initial:!1,children:m&&(0,F.jsx)(z.E.div,{initial:{opacity:0,x:"100%",width:0,marginRight:0},animate:{opacity:1,x:0,width:"auto",marginRight:-24,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{opacity:0,x:"100%",width:0,marginRight:0,transition:{duration:.4,ease:[.25,1,.5,1]}},children:(0,F.jsx)(rD,{variant:"secondary",theme:null!=o?o:l.theme,mode:null!=i?i:l.mode,customTheme:null!=r?r:l.customTheme,style:{overflow:"hidden"},children:(0,F.jsx)(z.E.div,{style:{paddingRight:24},children:(0,F.jsx)(rU,{hideSymbol:!0})})})},"balance")}),(0,F.jsx)(rD,{theme:null!=o?o:l.theme,mode:null!=i?i:l.mode,customTheme:null!=r?r:l.customTheme,style:C&&n&&h&&("retro"===o||"retro"===l.theme)?{boxShadow:"var(--ck-connectbutton-balance-connectbutton-box-shadow)",borderRadius:"var(--ck-connectbutton-balance-connectbutton-border-radius)",overflow:"hidden"}:{overflow:"hidden"},children:(0,F.jsx)(rQ,{separator:b,showAvatar:t,label:e})})]})})}rP.displayName="ConnectKitButton.Custom",rX.Custom=rP;let rJ=(0,R.F4)`
  0%{ transform:none; }
